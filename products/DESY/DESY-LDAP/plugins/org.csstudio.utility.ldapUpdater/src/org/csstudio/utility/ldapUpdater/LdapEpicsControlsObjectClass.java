...
public enum LdapEpicsControlsObjectClass implements ILdapObjectClass<LdapEpicsControlsObjectClass> {
    ...
    static {
        ...
        ROOT._nestedClass = FACILITY;
        FACILITY._nestedClass = COMPONENT;
        COMPONENT._nestedClass = IOC;
        IOC._nestedClass = RECORD;
     ...
     */
    private LdapEpicsControlsObjectClass _nestedClass;
    ...
    public Set<LdapEpicsControlsObjectClass> getNestedContainerClasses() {
        return Collections.singleton(_nestedClass);
    }
