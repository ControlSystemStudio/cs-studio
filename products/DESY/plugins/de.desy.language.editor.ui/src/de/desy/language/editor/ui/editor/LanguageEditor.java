...
public abstract class LanguageEditor extends TextEditor {
	 ...
	 * {@link DefaultDamagerRepairer}, this instance should be the same like
	 * the one returned by {@link #doGetPresentationRepairer(ITokenScanner)}.
	 * 
	 ...
	 * {@link DefaultDamagerRepairer}, this instance should be the same like
	 * the one returned by {@link #doGetPresentationDamager(ITokenScanner)}.
	 * 
	 * Example (damagerRepairer may be a field):
	 * 
	 * <pre>
