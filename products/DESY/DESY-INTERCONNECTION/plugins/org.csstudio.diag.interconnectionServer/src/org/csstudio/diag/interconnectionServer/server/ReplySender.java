...
//	private static final String replyTagName = "REPLY";
	 ...
	 */
	public static void sendSuccess(int id, IIocMessageSender sender) {
	 ...
	 *            the sender which sends the message to the IOC.
	 */
	public static void sendError(int id, IIocMessageSender sender) {
	 ...
	 *            the sender which sends the message to the IOC.
	 */
	public static void send(int id, boolean success, IIocMessageSender sender) {
		if (success) {
