#!/bin/bash
#+======================================================================
# $HeadURL: https://svnpub.iter.org/codac/iter/codac/dev/units/m-iter-units-api/tags/CODAC-CORE-4.0B5/src/main/resources/test_template.sh $
# $Id: test_template.sh 33482 2013-01-18 17:09:46Z zagara $
#
