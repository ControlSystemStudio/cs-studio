...
public class Preferences
{
	...
	public static boolean isAutenticateUser() {
		final IPreferencesService service = Platform.getPreferencesService();
		return service.getBoolean("org.csstudio.logbook.ui",
				"Autenticate.user", true, null);
	}

	public static String getLogbookUser() {
		final IPreferencesService service = Platform.getPreferencesService();
		return service.getString("org.csstudio.utility.olog", "user",
				"anonymous", null);
	}
