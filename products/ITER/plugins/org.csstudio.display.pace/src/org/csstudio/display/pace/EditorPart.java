    ...
    implements ModelListener
{
    ...
    public void doSave(final IProgressMonitor monitor)
    {
        ...
        try
        {
            ...
            {
                @Override
                public void save(String user, final String password,
                        final Collection<String> logbooks, final String title, final String body) throws Exception
                {
                    ...
                    if(user == null && password == null) {
                    	client = log_client_factory.getClient();
                    	
                    	// Get logbook user
                    	user = Preferences.getLogbookUser();
                    } else {
                    	client = log_client_factory.getClient(user, password);
                    }
                    try
                    {   // Change PVs.
