...
public class ScanInfoModelREST
{
    /** Singleton instance */
    private static ScanInfoModelREST instance;
     ...
     *  @return {@link ScanInfoModelREST}
     *  @throws Exception on error creating the initial instance
     *  @see #release()
     */
    public static ScanInfoModelREST getInstance() throws Exception
    {
        synchronized (ScanInfoModelREST.class)
        {
            if (instance == null)
            {
                setInstance(new ScanInfoModelREST());
                instance.start();
            }
            ++instance.references;
            return instance;
    ...
    private static void setInstance(final ScanInfoModelREST model)
    {
        instance = model;
    }
        ...
        poller = new Thread(new Runnable()
        {
            ...
            public void run()
            {
                while (poller != null)
                {
                    ...
                    {
                        Logger.getLogger(ScanInfoModelREST.class.getName()).
