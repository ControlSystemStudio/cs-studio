...
public abstract class AbstractGUIAction extends Action
{
     ...
     *  @param icon
     */
    public AbstractGUIAction(final ScanInfoModel model, final ScanInfo info, final String label, final String icon)
    {
        super(label, Activator.getImageDescriptior(icon));
        this.model = model;
        this.info = info;
    }
