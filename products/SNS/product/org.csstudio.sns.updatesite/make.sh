...
then
    ...
    ## Basic EPICS
    sh patch_product.sh I.epics_css_$VERSION/epics_css_$VERSION-macosx.cocoa.x86_64.zip CSS_EPICS_$VERSION apps/epics_css_$VERSION-macosx.cocoa.x86_64.zip $JRE_Macosx64
    ...
    ## SNS CSS
    sh patch_product.sh I.sns_css_$VERSION/sns_css_$VERSION-macosx.cocoa.x86_64.zip     CSS_$VERSION       apps/sns_css_$VERSION-macosx.cocoa.x86_64.zip   $JRE_Macosx64
