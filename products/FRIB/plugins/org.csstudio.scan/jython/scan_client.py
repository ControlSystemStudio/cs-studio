...
#     provide the path to the plugin directory of a CSS setup that includes
#     the scan plugins (during development, can also use the IDE's source dir)
plugin_install_location="../../"
#     ... or set the path to the standalone scan.client.jar
