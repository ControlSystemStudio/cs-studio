...
{
    private static final String BUNDLE_NAME = "org.csstudio.trends.sscan.messages"; //$NON-NLS-1$
    ...
    public static String XAxisMax;
    public static String XAxisMin;
    public static String YAxisMax;
    public static String YAxisMin;
    public static String AxisTT;
    public static String xAxisTT;
    public static String yAxisTT;
    ...
    public static String OpenSscanPerspective;
    ...
    public static String ValueXAxisName;
    public static String ValueYAxisName;
