 ...
 *  @author Kay Kasemir
 */
public class MacroStack implements IMacroTableProvider
{
     ...
     */
    public MacroStack(final String names_and_values) throws Exception
    {
        push(names_and_values);
    }
     ...
     *  @see #pop()
     */
    public void push(final String names_and_values) throws Exception
    {
