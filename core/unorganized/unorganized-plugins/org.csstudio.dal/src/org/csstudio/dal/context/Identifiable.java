...
/**
 * <code>Identifiable</code> interface represents the basic
 * interface which all objects interacting with the DAL system
 * should implement. It allows the system to determine the exact name
 * of the interacting component. It enables easier integration with services, such as
