...
public final class AlarmIcons {
    ...
    private static final String DISABLED = "disabled.png";
    ...
    private AlarmIcons() {
        ...
        registry.put(DISABLED, Activator.getImageDescriptor(ICONS + DISABLED));
    }
    
    /**
     * @return icon descriptor representing a general disabled state
     */
    public ImageDescriptor getDisabled() {
        return registry.get(DISABLED);
    }
