...
public class PropertyProxyUtilities {
	...
	{
	    if (data == null) return null;  // return null if Object is null !
	...
	static int getObjectSize(Object data) {
	    ...
	    if (data instanceof TTaggedStructure[]) return ((TTaggedStructure[])data).length;
	    if (data instanceof TTaggedStructure) return 1;
	...
	static Map<String, Object> getCharacteristics(PropertyNameDissector dissector, Class numberType) throws ConnectionFailed {
        ...
        if (Long.class.equals(numberType)) {
	        characteristics.put(NumericPropertyCharacteristics.C_MAXIMUM, (long)info[0].prpMaxValue);
	        characteristics.put(NumericPropertyCharacteristics.C_MINIMUM, (long)info[0].prpMinValue);
        } else {
	        characteristics.put(NumericPropertyCharacteristics.C_MAXIMUM, (double)info[0].prpMaxValue);
	        characteristics.put(NumericPropertyCharacteristics.C_MINIMUM, (double)info[0].prpMinValue);
        }
