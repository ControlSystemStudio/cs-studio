...
public class SimpleDemo {
	...
	public static void main(String[] args) throws RemoteException,
		...
		try {
			...
			// <protocol, always TINE>/<context name>/<group name>/<device
			// name>/<property name>
			...
			// print out configuration, which can be used on arbitrary
			// application context
			ctx.getConfiguration().store(System.out,
					"TINE application context configuration");
			...
			// for (DynamicValueState s : property.getCondition().getStates())
