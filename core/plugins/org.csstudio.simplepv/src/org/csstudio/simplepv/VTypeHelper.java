...
/**
 * A helper for PVManager related operations which are not provided by  {@link ValueUtil}
...
public class VTypeHelper {
	...
	/**
	 * Get the basic data type of a single VType value.
	 * If it is not a basic data type, it will return BasicDataType.UNKNOWN.
	 * 
	 * @param obj
	 *            The PV Manager VType value.
	 * @return the data type.
	 */
	public static BasicDataType getDataType(Object obj) {
	 ...
	 * @return
	 */
	public static String formatValue(FormatEnum formatEnum, Object pmValue, int precision) {
