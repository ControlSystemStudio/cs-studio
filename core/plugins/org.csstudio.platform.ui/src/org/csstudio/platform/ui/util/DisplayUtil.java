...
public class DisplayUtil
{
    ...
    private DisplayUtil()
    {
        ...
        for (IConfigurationElement element : confElements)
        {
            ...
            {
                CentralLogger.getInstance().getLogger(this).error("Error locating IOpenDisplayActions", ex);
            }
        }
    }
	...
	public void openDisplay(final String path, final String data) throws Exception
	{
		...
		if (action == null)
	        throw new Exception(NLS.bind(Messages.DisplayUtil_ErrorUnkownExtFmt, ext));
