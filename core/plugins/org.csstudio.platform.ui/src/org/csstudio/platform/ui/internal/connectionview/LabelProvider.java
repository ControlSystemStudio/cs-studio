...
final class LabelProvider extends ColumnLabelProvider {
	...
	private String getText(final Object element, final int columnIndex) {
		...
		Object v = connectorStatistic.getLatestValue();
		switch (columnIndex) {
		case 0:
	...
	public String getToolTipText(final Object element) {
		...
		IProcessVariableAddress pv = connectorStatistic
...
//		}
	...
	private Image getImage(final Object element, final int index) {
		...
		switch (index) {
		case 0:
			ControlSystemEnum controlSystem = connector.getProcessVariableAddress().getControlSystem();
