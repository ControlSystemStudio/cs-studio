 ...
 */
public interface MutablePropertyCollection<T extends DynamicValueProperty>
	extends PropertyCollection<T>, Collection<T>
{
	...
	/**
	 * Removes all property elements from this collection, whose unique
	 * name macthes with the provided name.
	 *
	 ...
	 * @see #add(T)
	 */
	boolean addAll(PropertyCollection c);
	 ...
	 * @see #remove(Object)
	 */
	boolean retainAll(PropertyCollection c);
	 ...
	 * @see #remove(String)
	 */
	boolean removeAll(PropertyCollection c);
