 ...
 *
 */
public class LinkBlocker extends LinkAdapter
{
	ConnectionEvent e;
	 ...
	 */
	public static final LinkBlocker blockUntillConnected(Linkable l,
	    long timeout, boolean throwException) throws ConnectionException
	{
		LinkBlocker b = new LinkBlocker(l);
	...
	/* (non-Javadoc)
	 * @see org.epics.css.dal.context.LinkAdapter#connected(org.epics.css.dal.context.ConnectionEvent)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.epics.css.dal.context.LinkAdapter#connectionFailed(org.epics.css.dal.context.ConnectionEvent)
	 */
	@Override
		...
		if (throwException) {
			if (e == null) {
				throw new ConnectionException(l,
				    "Connection failed, timeout exceeded.", null);
			}
