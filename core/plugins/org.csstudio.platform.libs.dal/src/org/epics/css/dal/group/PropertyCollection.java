 ...
 */
public interface PropertyCollection<T extends DynamicValueProperty>
{
	/**
	...
	/**
	 * Registeres provided listener for membership modification events.
	...
	/**
	 * Deregisteres provided listener for membership modification
	 * events.
	 *
	 * @param l the membership events listener
	 */
