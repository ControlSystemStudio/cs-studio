...
public interface Response
{
	...
	/**
	 * Returns <code>true</code> if this is last response in serie of
	 * responses.
	 *
	 * @return <code>true</code> if it is last reponse
	 */
	public boolean isLast();

	/**
	 * Returns <code>true</code> if the request was successfuly completed.
	 *
