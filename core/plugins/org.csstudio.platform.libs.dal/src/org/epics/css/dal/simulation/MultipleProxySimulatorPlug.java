...
public class MultipleProxySimulatorPlug extends SimulatorPlug {
    ...
    Runnable{
        ...
        public MonitorProxyI(final SinglePropertyProxyImpl<T> source, final ResponseListener<T> l) {
            super(source, l);
            this.proxy = source;
            resetTimer();
        }
        
        public void reInitialize(final SinglePropertyProxyImpl<T> proxy) throws RemoteException
        {
            this.source = proxy;
            this.proxy = proxy;
        }
         ...
         */
        public void setTimerTrigger(final long trigger)
    ...
    public static class DoublePropertyProxyImpl extends SinglePropertyProxyImpl<Double> {
        ...
        public DoublePropertyProxyImpl(final String name) {
            super(name);
    ...
    PropertyProxy<E>,SyncPropertyProxy<E> {
        ...
        public SinglePropertyProxyImpl(final String name) {
            super(name);
            delayedConnect(1000);
        }
        
        public void delayedConnect(final long timeout)
        {
            if (timeout > 0) {
                Timer t = new Timer();
        ...
        public MonitorProxy createMonitor(final ResponseListener<E> callback, final RemoteInfo.ChangeType changeType) throws RemoteException {
        ...
        public Request<E> getValueAsync(final ResponseListener<E> callback) throws DataExchangeException {
        ...
        public Request<E> setValueAsync(final E value, final ResponseListener<E> callback) throws DataExchangeException {
            if (getConnectionState() != ConnectionState.CONNECTED) {
                throw new DataExchangeException(this, "Proxy not connected");
            }
        ...
        public void setValueSync(final E value) throws DataExchangeException {
            if (getConnectionState() != ConnectionState.CONNECTED) {
                throw new DataExchangeException(this, "Proxy not connected");
            }
            ...
            for (MonitorProxyImpl element : m) {
                element.fireValueChange();
            }
        }
    }
    ...
    DeviceProxy {
        ...
        public SingleDeviceProxyImpl(final String name) {
            super(name);
        ...
        public CommandProxy getCommand(final String name) throws RemoteException {
            return commands.get(name);
        }
        
        public DirectoryProxy getDirectoryProxy(final String name) throws RemoteException {
        ...
        public PropertyProxy<?> getPropertyProxy(final String name) throws RemoteException {
    ...
    public static final synchronized MultipleProxySimulatorPlug getInstance(final Properties conf)
    {
        if (instance == null) {
    ...
    protected MultipleProxySimulatorPlug(final Properties configuration) {
        super(configuration);
    ...
    @Override
    protected <TT extends PropertyProxy<?>> TT createNewPropertyProxy(final String uniqueName, final Class<TT> type) throws ConnectionException {
        try {
    ...
    @Override
    protected <T extends DeviceProxy> T createNewDeviceProxy(final String uniqueName, final Class<T> type) throws ConnectionException {
        try {
