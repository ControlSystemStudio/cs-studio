...
implements PropertyFactory
{
    ...
    {
        return createProperty(uniqueName, null, null, RemoteInfo.ChangeType.UNDEFINED);
    }
    ...
    throws InstantiationException, RemoteException
    {
        return createProperty(ri.getRemoteName(), null, null, ri.getChangeType());
    }
    
    
    private DynamicValueProperty<?> createProperty(final String uniqueName,
                                                   final Class<? extends DynamicValueProperty<?>> type,
                                                           final LinkListener<?> l,
                                                           final RemoteInfo.ChangeType changeType) throws RemoteException {
        ...
        try {
            ...
            // TODO jp CT Review
            // The change type is set at the newly created property
            property.setChangeType(changeType);
     ...
     */
    private DynamicValueProperty<?> getFromFamily(final String uniqueName,
                                                  final Class<? extends DynamicValueProperty<?>> type) {
        if (type == null) {
    ...
    public <P extends DynamicValueProperty<?>> P getProperty(final String uniqueName,
                                                             final Class<P> type, final LinkListener<?> l, final RemoteInfo.ChangeType changeType)
    throws InstantiationException, RemoteException
    {
        if (type == null) {
        ...
        return type.cast(createProperty(uniqueName,type,l, changeType));
    }
    
    // Only used for tests
    public <P extends DynamicValueProperty<?>> P getProperty(final String uniqueName,
                                                             final Class<P> type, final LinkListener<?> l)
    throws InstantiationException, RemoteException
    {
        if (type == null) {
            throw new IllegalArgumentException("type may not be null");
        ...
        // TODO jp CT The change type is currently not retrieved from the string uniqueName
        return type.cast(createProperty(uniqueName,type,l, RemoteInfo.ChangeType.UNDEFINED));
    }
    ...
    throws InstantiationException, RemoteException
    {
        return getProperty(ri.getRemoteName(), type, l, ri.getChangeType());
    }
     ...
     */
    private void connect(final String uniqueName,
                         final Class<?extends SimpleProperty<?>> type, final Class<?extends SimpleProperty<?>> implementationType, final DynamicValuePropertyImpl<?> property)
    throws ConnectionException
    {
