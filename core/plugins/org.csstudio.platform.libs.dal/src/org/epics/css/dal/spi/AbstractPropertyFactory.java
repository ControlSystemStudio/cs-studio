	...
	implements PropertyFactory
{
	...
	private SimpleProperty createProperty (String uniqueName,
		    Class<?extends SimpleProperty> type, LinkListener l) throws RemoteException
	{
		if (family.contains(uniqueName)) {
			return family.get(uniqueName);
		}
	...
	public RemoteInfo asyncLinkProperty(RemoteInfo name,
		...
		throws InstantiationException, RemoteException
	{
		DynamicValuePropertyImpl property = (DynamicValuePropertyImpl)family.get(name
			    .getRemoteName());
