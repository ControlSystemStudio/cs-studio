...
public abstract class StringPropertyTestStandard
	extends DynamicValuePropertyTest
{
	public StringPropertyTestStandard()
	{
		super();
	}
	...
	public Object getRandomValue()
	{
		String[] strings = {
				"", "a", "test", "some String",
				"A very  long string sdkljsdalkjfsdlkjfdsakjasdčkjčkasdjfčkasdjfčkasjdčfkasjdčfkjasdčkfjasdčkjfasčdkjfčasdkjfsladkjflsdkjfasdkljhsa"
			};
		int r = (new Random()).nextInt(strings.length);
	...
	{
		assertEquals(got.getClass(), String.class);
		assertEquals(((String)expected), ((String)got));
	...
	{
		assertEquals(getProperty().getDataType(), String.class);
	}
}
