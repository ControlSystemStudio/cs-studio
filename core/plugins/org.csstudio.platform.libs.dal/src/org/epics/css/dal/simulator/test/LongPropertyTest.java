...
import org.epics.css.dal.impl.test.LongPropertyTestStandard;
...
public class LongPropertyTest extends LongPropertyTestStandard
{
	private static PropertyFactory pfac;
	private static AbstractApplicationContext ctx;
	private static LongProperty prop;
	...
	public LongPropertyTest(LongProperty property)
	{
		prop = property;
	...
	{
		if (prop == null) {
			name = new String("LongProperty");

			try {
				prop = pfac.getProperty(name, LongProperty.class, null);
			} catch (Exception e) {
				e.printStackTrace();
				fail(e.toString());
			}
