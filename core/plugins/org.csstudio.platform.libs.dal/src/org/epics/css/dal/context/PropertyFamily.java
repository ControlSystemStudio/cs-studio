...
import org.epics.css.dal.group.GroupDataAccessProvider;
import org.epics.css.dal.group.PropertyCollection;


/**
 * Family is container for propertyes, which is contents can be changed only by
 * creating new property or deleting old one, yet this is not directly
 * implemented int the family but rather delegated to the underalying pluggable
 * implementation. In contrast to ordynary <code>PropertyCollection</code>
 ...
 */
public interface PropertyFamily<T extends DynamicValueProperty>
	extends PropertyCollection<T>, GroupDataAccessProvider, PropertyContext
{
	/**
