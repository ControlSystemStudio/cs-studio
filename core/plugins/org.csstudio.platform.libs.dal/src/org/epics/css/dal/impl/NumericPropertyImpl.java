 ...
 *
 */
public class NumericPropertyImpl<T> extends DynamicValuePropertyImpl<T>
	implements NumericProperty<T>
{
	...
	/* (non-Javadoc)
	 * @see org.epics.css.dal.NumericSimpleProperty#getFormat()
	 */
	 ...
	 */
	public T getMaximum() throws DataExchangeException
	{
		return valClass.cast(directoryProxy.getCharacteristic(C_MAXIMUM));
	}

	/* (non-Javadoc)
	 * @see org.epics.css.dal.NumericSimpleProperty#getMinimum()
	 */
	public T getMinimum() throws DataExchangeException
	{
		return valClass.cast(directoryProxy.getCharacteristic(C_MINIMUM));
	}

	/* (non-Javadoc)
	 * @see org.epics.css.dal.NumericSimpleProperty#getUnits()
	 */
