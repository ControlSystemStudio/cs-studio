	...
	extends PropertyCollection<P>, GroupUpdateable
{
	 ...
	 */
	public void addDynamicValuesListener(DynamicValuesListener l);
	 ...
	 * @param l the listener object
	 */
	public void removeDynamicValuesGroupListener(DynamicValuesListener l);
	 ...
	 */
	public DynamicValuesListener[] getDynamicValuesListeners();
	 ...
	 */
	public DynamicValueProperty[] getTimeoutProperties();
	 ...
	 */
	public DynamicValueProperty[] getTimelagProperties();
