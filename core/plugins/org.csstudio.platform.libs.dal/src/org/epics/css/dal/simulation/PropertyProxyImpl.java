...
implements PropertyProxy<T>, SyncPropertyProxy<T>, DirectoryProxy
{
    ...
    public static void main(final String[] args) throws Exception, InstantiationException {
     ...
     * @param name
     */
    public PropertyProxyImpl(final String name, final Class<T> type)
    {
     ...
     * @param connectDelay
     */
    public PropertyProxyImpl(final String name, final long connectDelay, final Class<T> type)
    {
        super(name);
    ...
    public void setSettable(final boolean settable)
    {
     ...
     */
    public void setCondition(final DynamicValueCondition s)
    {
     ...
     */
    public Class[] getCommandParameterTypes(final String commandName)
    throws DataExchangeException
    {
        // property does not support commands
        throw new UnsupportedOperationException();
    ...
    public Request<? extends Object> getCharacteristics(final String[] characteristics,
        ...
        for (String characteristic : characteristics) {
            Object value = PropertyUtilities.verifyCharacteristic(this, characteristic, getCharacteristic(characteristic));
            r.addResponse(new ResponseImpl<Object>(this, r, value, characteristic,
     ...
     */
    public Class<?extends SimpleProperty<T>> getPropertyType(final String propertyName)
            {
        throw new UnsupportedOperationException("This is not device proxy.");
            }
     ...
     */
    public void setValueProvider(final ValueProvider<T> valueProvder)
    {
        try {
     ...
     */
    public void simulateConnectionState(final ConnectionState state)
    {
        setConnectionState(state);
    }
    
    public void simulateCharacteristicChange(final String characteristicName, final Object value) {
