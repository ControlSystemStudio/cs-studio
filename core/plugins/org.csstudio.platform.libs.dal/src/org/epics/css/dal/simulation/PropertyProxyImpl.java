	...
	implements PropertyProxy<T>, SyncPropertyProxy<T>, DirectoryProxy
{
		...
		throws DataExchangeException
	{
		...
		r.addResponse(new ResponseImpl(this, r, valueProvider.get(), "value",
		...
		throws DataExchangeException
	{
		...
		RequestImpl r = new RequestImpl(this, callback);
		r.addResponse(new ResponseImpl(this, r, value, "", true, null,
		        condition, null, true));
	 ...
	 */
	public MonitorProxy createMonitor(ResponseListener callback)
	    ...
	    ResponseListener callback) throws DataExchangeException
	{
		...
		for (int i = 0; i < characteristics.length; i++) {
			Object value = getCharacteristic(characteristics[i]);
