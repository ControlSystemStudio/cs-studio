...
{
	private DeviceFamilyImpl family;
	...
	{
		family = new DeviceFamilyImpl(this);
	}

	/* (non-Javadoc)
	 * @see org.epics.css.dal.spi.DeviceFactory#getDevice(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see org.epics.css.dal.spi.DeviceFactory#getDevice(org.epics.css.dal.context.RemoteInfo)
	 */
	...
	/* (non-Javadoc)
	 * @see org.epics.css.dal.spi.DeviceFactory#getDevice(java.lang.String, java.lang.Class, org.epics.css.dal.context.LinkListener)
	 */
	public <D extends AbstractDevice> D getDevice(String uniqueName,
	    Class<D> type, LinkListener l)
		throws InstantiationException, RemoteException
	{
		...
		try {
			...
			Class impClass = getPlugInstance()
				.getDeviceImplementationClass(type);
			...
			if (linkPolicy != LinkPolicy.NO_LINK_POLICY) {
				connect(uniqueName, type, device);
	...
	private void connect(String uniqueName,
	    Class<?extends AbstractDevice> type, AbstractDeviceImpl device)
		throws ConnectionException
	{
	...
	/* (non-Javadoc)
	 * @see org.epics.css.dal.spi.DeviceFactory#getDevice(org.epics.css.dal.context.RemoteInfo, java.lang.Class, org.epics.css.dal.context.LinkListener)
	 */
	...
	/* (non-Javadoc)
	 * @see org.epics.css.dal.spi.DeviceFactory#asyncLinkDevice(org.epics.css.dal.context.RemoteInfo, org.epics.css.dal.context.LinkListener)
	 */
		...
		throws InstantiationException, RemoteException
	{
		...
		if (device == null) {
			try {
				...
				connect(name.getRemoteName(), null, device);
	...
	/* (non-Javadoc)
	 * @see org.epics.css.dal.spi.DeviceFactory#asyncLinkDevice(java.lang.String, org.epics.css.dal.context.LinkListener)
	 */
	...
	/* (non-Javadoc)
	 * @see org.epics.css.dal.spi.DeviceFactory#getDeviceFamily()
	 */
	...
	/* (non-Javadoc)
	 * @see org.epics.css.dal.spi.DeviceFactory#reconnectDevice(org.epics.css.dal.device.AbstractDevice)
	 */
