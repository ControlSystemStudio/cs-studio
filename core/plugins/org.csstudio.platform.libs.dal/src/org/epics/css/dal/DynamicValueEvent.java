 ...
 *
 */
public class DynamicValueEvent<T, P extends SimpleProperty> extends SystemEvent<T, DataAccess<T>>
{
	 ...
	 */
	public DynamicValueEvent(DataAccess<T> source, P property, T value,
	    DynamicValueCondition condition, Timestamp timestamp, String message,
