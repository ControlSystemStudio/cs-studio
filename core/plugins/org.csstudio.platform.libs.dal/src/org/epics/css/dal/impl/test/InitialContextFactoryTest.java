...
public class InitialContextFactoryTest extends TestCase
{
	...
	protected void setUp() throws NamingException, IOException
	{
		...
		Object o = initialContext.lookup(new URIName(RemoteInfo.SCHEME_PREFIX
	...
	public void testSimulatorContextBuilder() throws NamingException
	{
		...
		URIName uri = new URIName(RemoteInfo.SCHEME_PREFIX
			    + SimulatorPlug.SCHEME_SUFFIX, SimulatorPlug.DEFAULT_AUTHORITY,
			    new PropertyProxyImpl("").getClass().getSimpleName(), null);
		...
		uri = new URIName(RemoteInfo.SCHEME_PREFIX
			    + SimulatorPlug.SCHEME_SUFFIX, SimulatorPlug.DEFAULT_AUTHORITY,
			    new DoublePropertyProxyImpl("").getClass().getSimpleName(), null);
	...
	{
		//test default values
		PropertyProxyImpl ppi = new PropertyProxyImpl("test");
		...
		PropertyProxyImpl ppi2 = new PropertyProxyImpl(name);
