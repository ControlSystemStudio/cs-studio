...
public class CentralLoggerTest {
	 ...
	 */
	private final String _testMessage = "test log message"; //$NON-NLS-1$

	/**
	 * A sample throwable for testing.
	 */
	private final Throwable _testThrowable = new Throwable("test throwable"); //$NON-NLS-1$
	...
	public final void testGetInstance() {
		final CentralLogger l1 = CentralLogger.getInstance();
		assertNotNull(l1);
		final CentralLogger l2 = CentralLogger.getInstance();
		assertEquals(l1, l2);
	}
