...
// TODO: rename set* to write*
// TODO: rename get* to read*
// TODO: rename register* to connect()
// TODO: rename register* to disconnect()
// TODO: Add asynchronous write* methods
 ...
 */
public interface CopyOfIProcessVariableConnectionService {
	 ...
	 */
	void writeValueAsynchronously(IProcessVariableAddress processVariableAddress, long value);
	 ...
	 * @return true, if the value was set successful, false otherwise
	 */
	void writeValueAsynchronously(IProcessVariableAddress processVariableAddress, double value);
	 ...
	 * @return true, if the value was set successful, false otherwise
	 */
	void writeValueAsynchronously(IProcessVariableAddress processVariableAddress, String value);
	...
	/**
	 * Returns information about the current user´s ability to write values to
	 * the channel that is addressed by the specified process variable address.
	 * 
	 * @param pv
	 *            the process variable address
	 * 
	 ...
	 */
	List<IConnector> getConnectorStatistic();
}
