...
public class SimpleDAL_TINETest extends TestCase {
	...
	public void testMandatoryCharacteristics() {
		...
		try {
			...
			for (int i = 0; i < infos.length; i++) {
				...
				String rawName= ControlSystemEnum.TINE.getPrefix()+"://TINE/DEFAULT/JavaIOC-EQM/valueOnly/valueOnly["+info.getName()+"]";
	...
	public void testGetValue() {
		...
		try {
			...
			String rawName= ControlSystemEnum.TINE.getPrefix()+"://TINE/DEFAULT/JavaIOC-EQM/valueOnly/valueOnly";
