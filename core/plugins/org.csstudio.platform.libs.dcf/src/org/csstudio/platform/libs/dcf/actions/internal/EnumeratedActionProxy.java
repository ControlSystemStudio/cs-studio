...
public class EnumeratedActionProxy extends SimpleActionProxy {
	
	private static final String ATT_VALUES = "values";
	
	private final String[] _params;
	public EnumeratedActionProxy(IConfigurationElement configElement) {
		super(configElement);
		_params = getParams(getAttribute(configElement, ATT_VALUES, ""));
	}
