 ...
 * to recieve notifications of recieved and sent messages
 * on the connection manager implementation.
 * 
 * @author avodovnik
 *
 */
public interface IMessageListener {
	/**
	 * Called when a message is recieved through the protocol
	 * implementation and connection manager.
	 * @param message The message that was recieved.
	 */
	public void notifyMessageRecieved(Message message);
	
	/**
	 * Called when a message is sent through the protocol 
	 * implementation and connection manager.
