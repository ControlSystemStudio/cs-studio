    ...
    public void propertyChange(PropertyChangeEvent evt) {
        if (model.getProperty(AbstractWidgetModel.PROP_COLOR_BACKGROUND) != null) {
            if ((boolean) evt.getNewValue()) {
                oldValue = model.getProperty(AbstractWidgetModel.PROP_COLOR_BACKGROUND).getPropertyValue();
                model.getProperty(AbstractWidgetModel.PROP_COLOR_BACKGROUND).setPropertyValue(TRANSPARENCY_VALUE);
            } else {
                model.getProperty(AbstractWidgetModel.PROP_COLOR_BACKGROUND).setPropertyValue(oldValue);
            }
        }
    }
}