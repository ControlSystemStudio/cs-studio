...
public class ROIFigure extends Figure {
        ...
        public ResizeHandler(int index) {
            ...
            case 3:
                ...
                handlerBoundsCalulator = new HandlerBoundsCalulator() {
                    @Override
                    public Rectangle calcBoundsFromROIBounds(Rectangle roiBounds) {
                        return super.calcBoundsFromROIBounds(roiBounds)
                                .translate(roiBounds.width, roiBounds.height / 2);
                    }
                };
                break;
            case 4:
            ...
            case 5:
                ...
                dragger = new CommonDragger() {
                    ...
                    protected void updateROIBounds(MouseEvent me) {
                        int dy = me.y - start.y;
                        setROIGeoBounds(startROIBounds.x, startROIBounds.y, startROIBounds.width, startROIBounds.height
                                + dy);
                    }
                };
                handlerBoundsCalulator = new HandlerBoundsCalulator() {
                    ...
                    public Rectangle calcBoundsFromROIBounds(Rectangle roiBounds) {
                        return super.calcBoundsFromROIBounds(roiBounds)
                                .translate(roiBounds.width / 2, roiBounds.height);
                    }
                };
                break;
            case 6:
    ...
    protected void paintFigure(Graphics graphics) {
        if (roiInfoProvider != null && roiDataBounds != null) {
            String text = roiInfoProvider.getROIInfo(roiDataBounds.x, roiDataBounds.y, roiDataBounds.width,
    ...
    private Rectangle getROIFromGeoBounds(PrecisionRectangle roiBounds) {
        ...
        return new Rectangle((int) Math.round(lt.preciseX()) + intensityGraphFigure.getCropLeft(), (int) Math.round(lt
                .preciseY()) + intensityGraphFigure.getCropTop(), (int) Math.ceil(rb.preciseX() - lt.preciseX()),
    ...
    private PrecisionRectangle getGeoBoundsFromROI(Rectangle roiDataBounds) {
        PrecisionPoint lt = ((GraphArea) getParent()).getGeoLocation(
                roiDataBounds.preciseX() - intensityGraphFigure.getCropLeft(), roiDataBounds.preciseY()
        ...
        return new PrecisionRectangle(lt.preciseX() - getBounds().x, lt.preciseY() - getBounds().y, rb.preciseX()
                - lt.preciseX(), rb.preciseY() - lt.preciseY());
    }
