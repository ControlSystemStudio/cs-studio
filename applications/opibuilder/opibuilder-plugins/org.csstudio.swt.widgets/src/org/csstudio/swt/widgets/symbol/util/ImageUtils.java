...
public final class ImageUtils {
    ...
    public static ImageData applyMatrix(ImageData srcData, PermutationMatrix pm) {
        ...
        ImageData newImageData = new ImageData(newWidth, newHeight, srcData.depth, srcData.palette);
    ...
    public static ImageData changeImageColor(Color color, ImageData originalImageData) {
        ...
        int luminance = (int) Math.round((0.299 * color.getRed()) + (0.587 * color.getGreen())
                + (0.114 * color.getBlue()));
    ...
    private static int applyShade(int shadedPixel, int pixelToShade, PaletteData palette) {
        int newColor = 0, redMask = palette.redMask, blueMask = palette.blueMask, greenMask = palette.greenMask, redShift = palette.redShift, greenShift = palette.greenShift, blueShift = palette.blueShift;
