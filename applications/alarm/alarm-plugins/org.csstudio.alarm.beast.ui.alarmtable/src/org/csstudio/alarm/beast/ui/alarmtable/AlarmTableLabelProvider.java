...
{    
     ...
     *  @param icon_provider Icons provider for the severity values
     *  @param column Column for which this label provider should give labels etc.
     */
    public AlarmTableLabelProvider(final SeverityColorProvider color_provider, final SeverityIconProvider icon_provider,
    ...
    public void update(final ViewerCell cell)
    {
        ...
        case ACK:
            ...
            break;
        case ICON:
            cell.setImage(icon_provider.getIcon(alarm.getCurrentSeverity(),alarm.getSeverity(),!alarm.isEnabled()));
            break;
        case PV:
