...
public class SyncStatementNode_Test extends TestCase {
    ...
    public void testNode() {
        final SyncStatementNode node = new SyncStatementNode("eventFlagName", "variableName", 23, 42);
        ...
        Assert.assertEquals("sync: eventFlagName is synchronized with variableName",
