...
public class SNLParser_Test extends TestCase {
    ...
    public void testSNLParser() {
        ...
        Assert.assertEquals(ProgramNode.class, programNode.getClass());
        Assert.assertEquals("sncExample", ((ProgramNode) programNode).getSourceIdentifier());
        ...
        Assert.assertEquals("init", ((AbstractSNLNode) stateSetChildrenNodes[0]).getSourceIdentifier());
        ...
        Assert.assertEquals("high", ((AbstractSNLNode) stateSetChildrenNodes[2]).getSourceIdentifier());
        ...
        Assert.assertEquals("{user}:aiExample", varNode.getAssignedChannelName());
        ...
        Assert.assertEquals(AssignStatementNode.class, childrenNodes[0].getClass());
        Assert.assertEquals("{user}:aiExample", ((AssignStatementNode) childrenNodes[0]).getContent());
        Assert.assertEquals(MonitorStatementNode.class, childrenNodes[1].getClass());
        ...
        Assert.assertEquals("+r", ((OptionStatementNode) node).getSourceIdentifier());
        ...
        final SyncStatementNode syncNode = (SyncStatementNode) eventFlagNode.getChildrenNodesAsArray()[0];
