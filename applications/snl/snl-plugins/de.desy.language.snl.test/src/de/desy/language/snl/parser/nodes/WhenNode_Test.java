...
public class WhenNode_Test extends TestCase {
    public void testWhenNodeWithoutContent() {
        final WhenNode whenNode = new WhenNode("x < y", null, "NEXT_ONE", 23, 42);
        ...
        Assert.assertEquals("when (x < y) -> NEXT_ONE", whenNode.humanReadableRepresentation());
    }

    public void testWhenNodeWithContent() {
        final WhenNode whenNode = new WhenNode("x < y", "pvPut(x,1);", "NEXT_ONE", 23, 42);
