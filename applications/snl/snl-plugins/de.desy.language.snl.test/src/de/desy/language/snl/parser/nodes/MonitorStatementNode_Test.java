...
public class MonitorStatementNode_Test extends TestCase {
    ...
    public void testNode() {
        final MonitorStatementNode node = new MonitorStatementNode("variableName", 23, 42);
        ...
        Assert.assertEquals("variableName is monitored", node.humanReadableRepresentation());
    }
}
