...
public class AssignStatementParser_Test extends TestCase {
    ...
    public void testParser() {
        ...
        Assert.assertEquals("assign l to \"epics://krykWeather.temp_ai.VAL\";", parser.getLastFoundStatement());
        ...
        Assert.assertEquals("epics://krykWeather.temp_ai.VAL", lastFoundAsNode.getContent());
    ...
    public void testArrayAssignment() {
        ...
        Assert.assertEquals("assign l[1] to \"epics://krykWeather.temp_ai.VAL\";", parser.getLastFoundStatement());
        final AssignStatementNode lastFoundAsNode = parser.getLastFoundAsNode();
        Assert.assertEquals("l", lastFoundAsNode.getSourceIdentifier());
        Assert.assertTrue(lastFoundAsNode.hasOffsets());
