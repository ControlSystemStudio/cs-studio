...
public class SingleLineCommentParser_Test extends TestCase {
    ...
    public void testFindNextCharSequence() {
        ...
        final SingleLineCommentNode lastFoundAsNode = parser.getLastFoundAsNode();
        Assert.assertNotNull(lastFoundAsNode);
        Assert.assertEquals("(single line comment)", lastFoundAsNode.getSourceIdentifier());
        ...
        Assert.assertEquals("//This is a comment", parser.getLastFoundStatement());
