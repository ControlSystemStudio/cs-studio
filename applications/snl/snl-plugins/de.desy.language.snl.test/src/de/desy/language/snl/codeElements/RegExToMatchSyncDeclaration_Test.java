...
public class RegExToMatchSyncDeclaration_Test extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        this._pattern = Pattern.compile("(sync\\s+)([a-zA-Z][0-9a-zA-Z]*)(\\s+to\\s+)([a-zA-Z][0-9a-zA-Z]*)(\\s*;)");
    }

    @Test
    public void testsimpleRegEx() {
        final Matcher matcher = this._pattern.matcher("sync testVariable to testFlag;");
    ...
    public void testsimpleRegExWithNoTo() {
        final Matcher matcher = this._pattern.matcher("sync testVariable testFlag;");
        Assert.assertFalse(matcher.matches());
