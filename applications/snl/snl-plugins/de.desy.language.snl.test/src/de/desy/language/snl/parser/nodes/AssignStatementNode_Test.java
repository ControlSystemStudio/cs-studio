...
public class AssignStatementNode_Test extends TestCase {
    ...
    public void testNode() {
        final AssignStatementNode node = new AssignStatementNode("variableName", "epics://krykWeather.temp_ai.VAL", 23,
                42, false);
        ...
        Assert.assertEquals("epics://krykWeather.temp_ai.VAL", node.getContent());
        Assert.assertEquals("variableName is assigned to \"epics://krykWeather.temp_ai.VAL\"",
