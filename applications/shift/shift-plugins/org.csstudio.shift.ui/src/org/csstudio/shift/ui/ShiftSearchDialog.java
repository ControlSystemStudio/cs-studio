...
public class ShiftSearchDialog extends Dialog {
    ...
    public ShiftSearchDialog(final Shell parentShell, final List<String> shifts,
    ...
    public Control createDialogArea(final Composite parent) {
        ...
        searchString.addModifyListener(new ModifyListener() {
            ...
            public void modifyText(final ModifyEvent e) {
                notificator.delayedExec(searchString, new Runnable() {
                    ...
                    @Override
                    public void run() {
                        setSearchParameters(ShiftSearchUtil
                ...
                notificator.delayedExec(textOwner, new Runnable() {
                    ...
                    public void run() {
                        searchParameters.put(
                                ShiftSearchUtil.SEARCH_KEYWORD_OWNER,
                                textOwner.getText());
                        updateSearch();
                    }
                });
        ...
        textStatus.addModifyListener(new ModifyListener() {
            ...
            public void modifyText(ModifyEvent e) {
                notificator.delayedExec(textStatus, new Runnable() {
                    ...
                    public void run() {
                        searchParameters.put(
                                ShiftSearchUtil.SEARCH_KEYWORD_STATUS,
                                textStatus.getText());
                        updateSearch();
                    }
                });
        ...
        shiftCombo.addPropertyChangeListener(new PropertyChangeListener() {
            ...
            public void propertyChange(final PropertyChangeEvent evt) {
                searchParameters.put(ShiftSearchUtil.SEARCH_KEYWORD_SHIFTS,
                        Joiner.on(",").join(shiftCombo.getSelection()));
                updateSearch();
            }
        });
        final Label lbTypes = new Label(container, SWT.NONE);
        lbTypes.setLayoutData(
                new GridData(SWT.RIGHT, SWT.CENTER, false, false, 1, 1));
        ...
        typeCombo.addPropertyChangeListener(new PropertyChangeListener() {
            ...
            @Override
            public void propertyChange(final PropertyChangeEvent evt) {
                searchParameters.put(ShiftSearchUtil.SEARCH_KEYWORD_TYPE,
                        Joiner.on(",").join(typeCombo.getSelection()));
                updateSearch();
            }
        });
        ...
        textFrom.addModifyListener(new ModifyListener() {
            ...
            public void modifyText(final ModifyEvent e) {
                notificator.delayedExec(textFrom, new Runnable() {
                    ...
                    public void run() {
                        searchParameters.put(
                                ShiftSearchUtil.SEARCH_KEYWORD_START,
                                textFrom.getText());
                        updateSearch();
                    }
                });
        ...
        btnNewButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                final StartEndDialog dlg = new StartEndDialog(getShell(),
                        textFrom.getText(), textTo.getText());
                if (dlg.open() != Window.OK)
                    return;
                textFrom.setText(dlg.getStartSpecification());
                searchParameters.put(ShiftSearchUtil.SEARCH_KEYWORD_START,
                        dlg.getStartSpecification());
                textTo.setText(dlg.getEndSpecification());
                searchParameters.put(ShiftSearchUtil.SEARCH_KEYWORD_END,
