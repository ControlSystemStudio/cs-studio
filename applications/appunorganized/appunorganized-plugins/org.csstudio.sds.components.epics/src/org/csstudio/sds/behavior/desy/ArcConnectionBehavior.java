...
/**
 *
 * Default DESY-Behavior for the {@link ArcModel} widget with Connection state
 *
 * @author hrickens
 ...
 * @since 20.04.2010
 */
public class ArcConnectionBehavior extends AbstractDesyConnectionBehavior<ArcModel> {

    private double _multi = 1;
