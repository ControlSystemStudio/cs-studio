 ...
 * @since 26.10.2011
 */
public class AlarmConnectionArcBehaviorTest extends
        AbstractArcBehaviorTest<ArcAlarmBehavior> {

    @Override
    protected ArcAlarmBehavior createBehavior() {
        return new ArcAlarmBehavior();
    }
