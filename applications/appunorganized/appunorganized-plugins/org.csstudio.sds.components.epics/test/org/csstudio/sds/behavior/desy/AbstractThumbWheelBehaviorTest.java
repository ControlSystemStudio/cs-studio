 ...
 * @since 26.10.2011
 */
public abstract class AbstractThumbWheelBehaviorTest<B extends AbstractBehavior<ThumbWheelModel>> extends AbstractBehaviorTest<ThumbWheelModel, B> {


    @Override
    protected ThumbWheelModel createModelMock() {
        final ThumbWheelModel mock = mock(ThumbWheelModel.class);
