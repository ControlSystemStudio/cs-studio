 ...
 * @since 26.10.2011
 */
public class ConnectionArcBehaviorTest extends
        AbstractArcBehaviorTest<ArcConnectionBehavior> {

    @Override
    protected ArcConnectionBehavior createBehavior() {
        return new ArcConnectionBehavior();
    }
