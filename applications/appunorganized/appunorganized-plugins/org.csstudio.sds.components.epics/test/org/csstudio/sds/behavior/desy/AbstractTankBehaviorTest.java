 ...
 * @since 26.10.2011
 */
public abstract class AbstractTankBehaviorTest<B extends AbstractBehavior<TankModel>> extends AbstractBehaviorTest<TankModel, B> {


    @Override
    protected TankModel createModelMock() {
        final TankModel mock = mock(TankModel.class);
        when(mock.getColor(TankModel.PROP_FILLBACKGROUND_COLOR)).thenReturn("UserDefinedBGColor");
        when(mock.getColor(TankModel.PROP_FILL_COLOR)).thenReturn("UserDefinedColor");
        return mock;
    }
