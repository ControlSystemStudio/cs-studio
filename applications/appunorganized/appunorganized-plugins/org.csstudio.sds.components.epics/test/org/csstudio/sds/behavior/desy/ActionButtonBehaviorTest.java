 ...
 * @since 26.10.2011
 */
public class ActionButtonBehaviorTest extends
        AbstractBehaviorTest<ActionButtonModel, ActionButtonBehavior> {

    @Override
    protected ActionButtonBehavior createBehavior() {
        return new ActionButtonBehavior();
    }
     ...
     */
    @Override
    protected ActionButtonModel createModelMock() {
        final ActionButtonModel mock = mock(ActionButtonModel.class);
