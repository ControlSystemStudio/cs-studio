 ...
 */
public class ScriptCodeElementRule implements IRule {
     ...
     */
    public ScriptCodeElementRule(final ILanguageElements codeElementToMatch,
     ...
     *            The token to be delivered on match.
     */
    public <T extends Enum<?> & ILanguageElements> ScriptCodeElementRule(
     ...
     *            The token to be delivered on match.
     */
    public ScriptCodeElementRule(final ILanguageElements[] codeElementsToMatch,
            final IToken tokenToDeliverOnMatch) {
