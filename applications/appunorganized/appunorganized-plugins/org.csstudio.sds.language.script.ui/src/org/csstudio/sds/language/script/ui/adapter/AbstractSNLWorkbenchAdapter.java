...
import org.csstudio.sds.language.script.ui.ScriptUiActivator;
...
public abstract class AbstractSNLWorkbenchAdapter<N extends AbstractScriptNode>
    ...
    /**
     * The adapted node (a subclass of {@link AbstractScriptNode}).
     */
    ...
    public final ImageDescriptor getImageDescriptor(final Object object) {
        ...
        return ScriptUiActivator.getImageDescriptor(fullPath);
    }
