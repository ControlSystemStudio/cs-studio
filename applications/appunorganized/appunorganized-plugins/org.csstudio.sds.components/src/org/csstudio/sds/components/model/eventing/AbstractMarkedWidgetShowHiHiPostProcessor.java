...
public class AbstractMarkedWidgetShowHiHiPostProcessor extends AbstractWidgetPropertyPostProcessor<AbstractMarkedWidgetModel> {
    ...
    protected Command doCreateCommand(final AbstractMarkedWidgetModel widget) {
        ...
        return new AbstractEnsureInvariantsCommand<AbstractMarkedWidgetModel>(widget, AbstractMarkedWidgetModel.PROP_SHOW_HIHI) {
            @Override
            ...
            protected String[] getPropertyIds() {
                return new String[] {AbstractMarkedWidgetModel.PROP_HIHI_COLOR};
            }
        };
    }
}
