...
import static org.csstudio.sds.components.model.AbstractScaledWidgetModel.PROP_SHOW_MINOR_TICKS;
import static org.csstudio.sds.components.model.AbstractScaledWidgetModel.PROP_SHOW_SCALE;
 ...
 * @since 03.05.2010
 */
public class AbstractMarkedWidgetShowScalePostProcessor extends AbstractWidgetPropertyPostProcessor<AbstractMarkedWidgetModel> {
    ...
    protected Command doCreateCommand(final AbstractMarkedWidgetModel widget) {
        ...
        return new AbstractEnsureInvariantsCommand<AbstractMarkedWidgetModel>(widget, PROP_SHOW_SCALE) {
            @Override
            ...
            protected String[] getPropertyIds() {
                return new String[] {PROP_SHOW_MINOR_TICKS, PROP_LOG_SCALE};
            }
        };
    }
