 ...
 * @since 30.04.2010
 */
public class AbstractMarkedWidgetShowLoLoPostProcessor extends AbstractWidgetPropertyPostProcessor<AbstractMarkedWidgetModel> {
    ...
    protected Command doCreateCommand(final AbstractMarkedWidgetModel widget) {
        ...
        return new AbstractEnsureInvariantsCommand<AbstractMarkedWidgetModel>(widget, AbstractMarkedWidgetModel.PROP_SHOW_LOLO) {
            @Override
            ...
            protected String[] getPropertyIds() {
                return new String[] {AbstractMarkedWidgetModel.PROP_LOLO_COLOR};
            }
        };
    }
}
