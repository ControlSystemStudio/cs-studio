 ...
 * @since 30.04.2010
 */
public class AbstractMarkedWidgetShowLoPostProcessor extends AbstractWidgetPropertyPostProcessor<AbstractMarkedWidgetModel> {
    ...
    protected Command doCreateCommand(final AbstractMarkedWidgetModel widget) {
        ...
        return new AbstractEnsureInvariantsCommand<AbstractMarkedWidgetModel>(widget, AbstractMarkedWidgetModel.PROP_SHOW_LO) {
            @Override
            ...
            protected String[] getPropertyIds() {
                return new String[] {AbstractMarkedWidgetModel.PROP_LO_COLOR};
            }
        };
    }
}
