...
public class ChannelFinderClientFromPreferences implements ChannelFinderClient {
    ...
    private static final Logger log = Logger
        .getLogger(ChannelFinderClientFromPreferences.class.getName());
    ...
    try {
        ...
        String url = prefs.getString(Activator.PLUGIN_ID,
            PreferenceConstants.ChannelFinder_URL,
            "http://localhost/ChannelFinder", null);
        String username = prefs.getString(Activator.PLUGIN_ID,
            PreferenceConstants.Username, null, null);
        final ISecurePreferences sec_prefs = SecurePreferences
        ...
        compositeClient
            .setWriter(CFCBuilder
                .serviceURL(url)
                .withHTTPAuthentication(true)
                .username(username)
                .password(
                    sec_prefs.node(Activator.PLUGIN_ID).get(
