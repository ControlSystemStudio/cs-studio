...
public class ChannelTreeByPropertyConfigurationPanel extends
    ...
    listWidget.addPropertyChangeListener(new PropertyChangeListener() {
        ...
        if (Arrays.asList("channels", "selectedProperties").contains(
            event.getPropertyName())) {
            changeSupport.firePropertyChange(new PropertyChangeEvent(
                this, event.getPropertyName(), event.getOldValue(),
                event.getNewValue()));
        }
        }
    });
