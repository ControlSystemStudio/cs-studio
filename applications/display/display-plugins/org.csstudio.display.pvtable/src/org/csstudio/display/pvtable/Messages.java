...
public class Messages extends NLS {
    ...
    public static String DeleteMesure;
    public static String DeleteMesure_TT;
    public static String DeleteLastMesure;
    public static String DeleteLastMesure_TT;
    public static String DeleteAllMesures;
    public static String DeleteAllMesures_TT;
    ...
    public static String InformationPopup_NoMesureToDel;
    public static String Insert;
    public static String Insert_TT;
    public static String InvalidFileExtension;
    public static String MesureAction;
    public static String MesureAction_TT;
    ...
    public static String QuestionPopupDelAllMesure;
    public static String QuestionPopupDelAllMesure_TT;
