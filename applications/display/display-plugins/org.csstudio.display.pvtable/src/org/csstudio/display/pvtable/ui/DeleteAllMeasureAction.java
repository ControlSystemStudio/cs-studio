...
public class DeleteAllMeasureAction extends PVTableAction {
    ...
    public void run() {
        ...
        boolean validation = MessageDialog.openQuestion(Display.getCurrent().getActiveShell(), Messages.QuestionPopupDelAllMeasure, Messages.QuestionPopupDelAllMeasure_TT);
        if(validation != true) {
        	return;
        }
