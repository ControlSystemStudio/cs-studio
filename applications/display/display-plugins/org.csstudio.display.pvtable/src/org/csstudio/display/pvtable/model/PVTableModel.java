...
public class PVTableModel implements PVTableItemListener {
     ...
     *
     * @param item
     *            Existing item. <code>null</code> to add at bottom.
     * @param pv_name
     *            PV name (or comment) of new item
     * @return Added item
     */
     ...
     * <p>
     * If only one item changed, update that item. If multiple items changed,
