...
/**
 * Implementation of the service provider accessing the activator's service registry
 * statically.
 *
 * @author bknerr
 * @since 20.06.2011
 */
public class ArchiveServiceProvider implements IArchiveServiceProvider {
