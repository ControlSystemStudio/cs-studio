 ...
 *
 */
public abstract class ChannelCommandHandler extends AbstractHandler implements IHandler {

	@Override
	public Object execute(ExecutionEvent event) throws ExecutionException {
		ISelection selection = HandlerUtil.getActiveMenuSelection(event);
		execute(Arrays.asList(AdapterUtil.convert(selection, Channel.class)), event);
		return null;
	}
	 ...
	 */
	protected abstract void execute(List<Channel> channels, ExecutionEvent event);
