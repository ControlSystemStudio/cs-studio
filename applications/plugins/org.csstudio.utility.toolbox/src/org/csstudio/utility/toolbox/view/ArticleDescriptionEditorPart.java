...
public class ArticleDescriptionEditorPart extends AbstractCrudEditorPartTemplate<ArticleDescription> implements
	...
	public void copy() {
		...
		getEditorInput().processData(new Func1Void<Some<ArticleDescription>>() {			
			@Override
			public void apply(Some<ArticleDescription> articleDescription) {
				ArticleDescription clone = articleDescription.get().deepClone();
