...
@Entity
@NamedQueries({ @NamedQuery(name = LagerOrt.FIND_ALL, query = "from LagerOrt l where l.lagerName = ? order by l.name"),
			@NamedQuery(name = LagerOrt.FIND_BY_NAME, query = "from LagerOrt l where l.lagerName = ? and name = ?") })
