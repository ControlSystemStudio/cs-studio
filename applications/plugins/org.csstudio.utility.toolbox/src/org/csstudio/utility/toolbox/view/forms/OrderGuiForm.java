...
public class OrderGuiForm extends AbstractGuiFormTemplate<Order> {
	...
	private void createPart(final Composite composite) {
		...
		Text nummer = wf.numericText(composite, "nummer").label("BA Number:").limitInputToDigits()
		...
		if (isSearchMode()) {
			...
			table.setLayoutData("skip, spanx 6, gaptop 20, ay top, growx, height 220:220:1250, wrap");
			table.setHeaderVisible(true);
			table.setLinesVisible(true);
