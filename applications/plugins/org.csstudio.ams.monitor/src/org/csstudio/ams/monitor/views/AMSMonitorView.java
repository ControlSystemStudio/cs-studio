...
public class AMSMonitorView extends ViewPart implements SelectionListener {
	...
	private final int[] intervals = new int[] { -1, 200, 500, 1000, 2000, 5000,
			10000 };
				...
				exporter.addJobChangeListener(new JobChangeAdapter() {
					...
					public void done(IJobChangeEvent e) {
						...
						if (event.getResult().isOK()) {
							...
							messageBox.setMessage("Excel export file is created");
							messageBox.open();
						} else {
							MessageBox messageBox2 = new MessageBox(Display.getDefault()
									.getActiveShell(), SWT.ERROR | SWT.ICON_ERROR);
							messageBox2.setText("Excel Export");
							messageBox2.setMessage("IO error, excel file could not created");
							messageBox2.open();
						}
							}
						});
