 ...
 * @since 18.12.2011
 */
public class OutgoingSmsQueue extends AbstractMessageQueue<SmsAlarmMessage> {
    ...
    @Override
    protected SmsAlarmMessage convertMessage(MapMessage message) {
        SmsAlarmMessage result = null;
        try {
            ...
            result = new SmsAlarmMessage(message.getJMSTimestamp(),
                                           Priority.NORMAL,
                                           phone,
                                           text,
                                           State.NEW,
