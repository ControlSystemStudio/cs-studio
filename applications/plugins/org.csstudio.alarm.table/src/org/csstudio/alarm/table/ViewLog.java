...
public class ViewLog extends ViewPart implements MessageListener {
	...
	public void createPartControl(Composite parent) {
		...
		String primCtxFactory = JmsLogsPlugin
				.getDefault()
				.getPluginPreferences()
				.getString(
						LogViewerPreferenceConstants.INITIAL_PRIMARY_CONTEXT_FACTORY);
		String primURL = JmsLogsPlugin.getDefault().getPluginPreferences()
				.getString(LogViewerPreferenceConstants.PRIMARY_URL);
		String secCtxFactory = JmsLogsPlugin
				.getDefault()
				.getPluginPreferences()
				.getString(
						LogViewerPreferenceConstants.INITIAL_SECONDARY_CONTEXT_FACTORY);
		String secURL = JmsLogsPlugin.getDefault().getPluginPreferences()
				.getString(LogViewerPreferenceConstants.SECONDARY_URL);
		String queues = JmsLogsPlugin.getDefault().getPluginPreferences()
				.getString(LogViewerPreferenceConstants.QUEUE); //$NON-NLS-1$

		initializeJMSConnection(parentShell, primCtxFactory, primURL,
				secCtxFactory, secURL, queues);
		...
		cl = new ColumnPropertyChangeListener(
				LogViewerPreferenceConstants.P_STRING, _tableViewer);
	...
	public void initializeJMSConnection(Shell ps, String primCtxFactory,
			String primURL, String secCtxFactory, String secURL, String topic) {
	...
	public void saveColumn() {
		...
		IPreferenceStore store = JmsLogsPlugin.getDefault()
				.getPreferenceStore();
		store.setValue(LogViewerPreferenceConstants.P_STRING,
