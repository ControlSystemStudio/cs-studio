...
public class TopicSet {
	...
	public TopicSet(String defTopic, String listOfTopics, String name,
			String popUp, String startUp, String font) {
		...
		if (font != null) {
			...
			try {
				_font = CustomMediaFactory.getInstance().getFont(fontItems[0], Integer.parseInt(fontItems[2]),
