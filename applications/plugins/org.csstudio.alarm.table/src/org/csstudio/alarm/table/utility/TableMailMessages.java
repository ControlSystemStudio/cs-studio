 ...
 */
public class TableMailMessages extends NLS
{
	private static final String BUNDLE_NAME = "org.csstudio.alarm.table.utility.messages"; //$NON-NLS-1$
	...
	static
    {
		...
		NLS.initializeMessages(BUNDLE_NAME, TableMailMessages.class);
	}
