 ...
 * is a SINGLETON because it maintains the state for several views even beyond their lifetime.
 * 
 * The log view and its subclasses use this service to map a topic set to lists of messages and
 * connections.
 * 
 * Usage:<br>
...
public interface ITopicsetService {
     ...
     * 
     * @param topicSet
     *            the topic set the connection is created for
     * @param messageList
     *            destination for the message listener
     */
    void createAndConnectForTopicSet(TopicSet topicSet, MessageList messageList);
