...
public class MailSenderDialog extends Dialog implements SelectionListener
{
    ...
    protected void configureShell(Shell shell)
    {
        ...
        shell.setText(TableMailMessages.getString("MailSenderDialog.DIALOG_TITLE"));
    }
    ...
    protected Control createDialogArea(Composite parent)
    {
        ...
        btnClearMEntry.setText(TableMailMessages.getString("MailSenderDialog.BUTTON_CLEAR"));
        ...
        labelFrom.setText(TableMailMessages.getString("MailSenderDialog.LABEL_FROM"));
        gd = new GridData();
        gd.grabExcessHorizontalSpace = true;
        gd.horizontalSpan = 1;
        ...
        textFrom.setText("username");//SecurityFacade.getInstance().getCurrentUser().getUsername());
        gd = new GridData();
        gd.horizontalSpan = 4;
        gd.horizontalAlignment = SWT.FILL;
        gd.grabExcessHorizontalSpace = true;        
        ...
        btnCarbonCopy.setText(TableMailMessages.getString("MailSenderDialog.LABEL_COPY"));
        ...
        labelTo.setText(TableMailMessages.getString("MailSenderDialog.LABEL_TO"));
        gd = new GridData();
        gd.horizontalSpan = 1;
        gd.horizontalAlignment = SWT.FILL;
        gd.grabExcessHorizontalSpace = true;        
        ...
        labelList.setText(TableMailMessages.getString("MailSenderDialog.LABEL_LIST"));
        gd = new GridData();
        gd.horizontalSpan = 1;
        gd.horizontalAlignment = SWT.FILL;
        gd.grabExcessHorizontalSpace = true;        
        ...
        addressHelper = new ComboHistoryHelper(JmsLogsPlugin.getDefault().getDialogSettings(),
        ...
        labelSubject.setText(TableMailMessages.getString("MailSenderDialog.LABEL_SUBJECT"));
        gd = new GridData();
        gd.horizontalSpan = 1;
        gd.horizontalAlignment = SWT.FILL;
        gd.grabExcessHorizontalSpace = true;        
        ...
        labelMailText.setText(TableMailMessages.getString("MailSenderDialog.LABEL_TEXT"));
        gd = new GridData();
        gd.horizontalSpan = 1;
        gd.verticalSpan = 5;
        gd.horizontalAlignment = SWT.FILL;
    ...
    protected Control createButtonBar(Composite parent)
    {
        ...
        buttonSend.setText(TableMailMessages.getString("MailSenderDialog.BUTTON_SEND"));
        ...
        buttonCancel.setText(TableMailMessages.getString("MailSenderDialog.BUTTON_CANCEL"));
    ...
    public void widgetSelected(SelectionEvent event)
    {
        if(event.widget instanceof Button)
        {
            ...
            if(source.getText().compareToIgnoreCase(TableMailMessages.getString("MailSenderDialog.BUTTON_SEND")) == 0)
            {
                createMailEntry();
            ...
            else if(source.getText().compareToIgnoreCase(TableMailMessages.getString("MailSenderDialog.BUTTON_CANCEL")) == 0)
            {
                this.setReturnCode(Dialog.CANCEL);
    
                this.close();
            }
            else if(source.getText().compareToIgnoreCase(TableMailMessages.getString("MailSenderDialog.BUTTON_CLEAR")) == 0)
            {
                textTo.setText("");
                textSubject.setText("");
