...
public class ArchiveViewPreferencePage
	...
	public void createFieldEditors() {
		...
		StringFieldEditor date = new StringFieldEditor(ArchiveViewPreferenceConstants.DATE_FORMAT,Messages.LogArchiveViewerPreferencePage_dateFormat,getFieldEditorParent());
		date.getLabelControl(getFieldEditorParent()).setToolTipText(Messages.LogArchiveViewerPreferencePage_javaDateFormat);
		addField(date);
		StringFieldEditor answerSize = new StringFieldEditor(ArchiveViewPreferenceConstants.MAX_ANSWER_SIZE,Messages.LogArchiveViewerPreferencePage_maxAnswerSize,getFieldEditorParent());
		answerSize.getLabelControl(getFieldEditorParent()).setToolTipText(Messages.LogArchiveViewerPreferencePage_javaDateFormat);
		addField(answerSize);
		StringFieldEditor answerSizeExport = new StringFieldEditor(ArchiveViewPreferenceConstants.MAX_ANSWER_SIZE_EXPORT,Messages.LogArchiveViewerPreferencePage_maxAnswerSizeExport,getFieldEditorParent());
		answerSize.getLabelControl(getFieldEditorParent()).setToolTipText(Messages.LogArchiveViewerPreferencePage_javaDateFormat);
