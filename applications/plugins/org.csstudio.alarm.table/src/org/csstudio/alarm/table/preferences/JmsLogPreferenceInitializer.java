...
public class JmsLogPreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public void initializeDefaultPreferences() {
		...
		store.setDefault(JmsLogPreferenceConstants.KEY0,"INVALID");
		store.setDefault(JmsLogPreferenceConstants.KEY1,"MAJOR");
		store.setDefault(JmsLogPreferenceConstants.KEY2,"MINOR");
		store.setDefault(JmsLogPreferenceConstants.KEY3,"NO_ALARM");
		...
		store.setDefault(JmsLogPreferenceConstants.COLOR0,"191,191,191");
		store.setDefault(JmsLogPreferenceConstants.COLOR1,"252,7,14");
		store.setDefault(JmsLogPreferenceConstants.COLOR2,"251,215,11");
		store.setDefault(JmsLogPreferenceConstants.COLOR3,"96,251,123");
		...
		store.setDefault(JmsLogPreferenceConstants.VALUE0,"INVALID");
		store.setDefault(JmsLogPreferenceConstants.VALUE1,"MAJOR");
		store.setDefault(JmsLogPreferenceConstants.VALUE2,"MINOR");
		store.setDefault(JmsLogPreferenceConstants.VALUE3,"NO_ALARM");
