...
public final class PathUtil {
	...
	public static IPath makePathRelativToAnchor(final IPath path,
		...
		if (referencePath.isPrefixOf(result)) {
			...
			if ((device == null && anchorDevice == null) || (device !=null && device.equals(anchorDevice))) {
				if (device != null) { 
	 ...
	 * @param path The {@link IPath}
	 * @return The device (ending with ':') or <code>null</code> if no device exists 
	 */
