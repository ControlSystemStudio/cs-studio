...
/**
 * Implementation of the topic set service.
 * 
 * A map is maintained, keeping the alarm connection and the message lists as values. The key is
 * given by the name of the topic set.
 * 
 * @author jpenning
 * @author $Author$
 * @version $Revision$
...
public class TopicsetService implements ITopicsetService {
     ...
     */
    @Override
    public void createAndConnectForTopicSet(final TopicSet topicSet, final MessageList messageList) {
