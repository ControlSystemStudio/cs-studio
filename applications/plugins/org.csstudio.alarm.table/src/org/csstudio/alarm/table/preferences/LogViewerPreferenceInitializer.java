...
public class LogViewerPreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public void initializeDefaultPreferences() {
		...
		store.setDefault(LogViewerPreferenceConstants.PRIMARY_URL, "failover:(tcp://krykjmsb.desy.de:64616)?maxReconnectAttempts=4&maxReconnectDelay=5000"); //$NON-NLS-1$
		...
		store.setDefault(LogViewerPreferenceConstants.SECONDARY_URL, "failover:(tcp://krykjmsa.desy.de:62616)?maxReconnectAttempts=4&maxReconnectDelay=5000"); //$NON-NLS-1$
