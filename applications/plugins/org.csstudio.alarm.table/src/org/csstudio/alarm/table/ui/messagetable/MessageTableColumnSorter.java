...
public class MessageTableColumnSorter extends ViewerSorter {
	...
	public MessageTableColumnSorter(String colName) {
		super();
		columnName = colName;
	}

	public MessageTableColumnSorter(String colName, boolean backwards) {
		super();
		columnName = colName;
		ascending = backwards;
	}
