...
public abstract class AbstractMatcher implements ArgumentsMatcher {
	...
	public boolean matches(final Object[] expected, final Object[] actual) {
		...
		for (int i = 0; i < expected.length; i++) {
			final Object expectedObject = expected[i];
			final Object actualObject = actual[i];
			...
			if (!this.argumentMatches(expectedObject, actualObject)) {
				return false;
			}
		}
		return true;
	...
	public String toString(final Object[] arguments) {
		Object[] localArguments = arguments;
		if (localArguments == null) {
			localArguments = new Object[0];
		}
