...
//		setDescription(Messages.getString("PreferencePage.LDAP")); //$NON-NLS-1$
	...
	protected void createFieldEditors() {
		...
		addField(new StringFieldEditor(SampleService.IOC_ADDRESS3,Messages.getString("View.1"),getFieldEditorParent()));
		final FileFieldEditor ffe = new FileFieldEditor(SampleService.snlDebugger_XML_FILE_PATH,Messages.getString("PageMain.File"),getFieldEditorParent()); //$NON-NLS-1$
		ffe.setFileExtensions(new String[]{"*.xml"}); //$NON-NLS-1$
		ffe.setStringValue("snlDebugger.xml"); //$NON-NLS-1$
		addField(ffe);
	}
