...
public final class Set_3 implements IRule {
	...
	public Object evaluate(final Object[] arguments) {
		if ((arguments != null) && (arguments.length > 0)) {
			...
			if (d>=3.99 && d<=4.01) {
				return ColorUtil.toHex(214,127,226);
			}
			if (d>=4.99 && d<=5.01) {
				return ColorUtil.toHex(174,78,188);
			}
			if (d>=5.99 && d<=6.01) {
				return ColorUtil.toHex(139,26,150);
			}
			if (d>=6.99 && d<=7.01) {
				return ColorUtil.toHex(97,10,117);
			}
			if (d>=7.99 && d<=8.01) {
				return ColorUtil.toHex(164,170,255);
			}
			if (d>=8.99 && d<=9.01) {
				return ColorUtil.toHex(135,147,226);
			}
			if (d>=9.99 && d<=10.01) {
				return ColorUtil.toHex(106,115,193);
			}
			if (d>=10.99 && d<=11.01) {
				return ColorUtil.toHex(77,82,164);
			}
			if (d>=11.99 && d<=12.01) {
				return ColorUtil.toHex(52,51,134);
			}
			if (d>=12.99 && d<=13.01) {
				return ColorUtil.toHex(199,187,109);
			}
			if (d>=13.99 && d<=14.01) {
				return ColorUtil.toHex(183,157,92);
			}
			if (d>=14.99 && d<=15.01) {
