...
public final class ArcModel extends AbstractWidgetModel {
	...
	protected void configureProperties() {
		...
		addIntegerProperty(PROP_STARTANGLE, "Start Angle", WidgetPropertyCategory.DISPLAY, 0, 0, 360, false);
		addIntegerProperty(PROP_ANGLE, "Angle", WidgetPropertyCategory.DISPLAY, 90, 0, 360, false);
		addIntegerProperty(PROP_LINEWIDTH, "Line Width", WidgetPropertyCategory.DISPLAY, 1, false);
		addBooleanProperty(PROP_FILLED, "Filled", WidgetPropertyCategory.DISPLAY, false, false);
		addColorProperty(PROP_FILLCOLOR, "Fill Color", WidgetPropertyCategory.DISPLAY, "#ff0000", false);
	}
