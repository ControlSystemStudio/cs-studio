...
public final class PolylineElement extends DisplayModelElement {
	 ...
	 */
	public static final String PROP_POINTS = "polyline.points";

	/**
	 * The ID of the fill grade property.
	 */
	public static final String PROP_FILL_GRADE = "line.fillgrade";
	 ...
	 */
	public static final String ID = "element.polyline";
