 ...
 * @since 01.06.2012
 */
public class RestartWorker implements IManagementCommand {
    ...
    public CommandResult execute(CommandParameters parameters) {
        ...
        remoteObject.restartDeliveryWorker();
        return CommandResult.createMessageResult("Hopefully all worker have been restarted.");
    }
}
