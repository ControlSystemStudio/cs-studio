/*
 * Copyright (c) 2012 Stiftung Deutsches Elektronen-Synchrotron, Member of the Helmholtz Association, (DESY), HAMBURG,
...
/**
 * Test for the message type service
 *
 * @author jpenning
 * @since 12.04.2012
 */
public class MessageTypesUnitTest {
    ...
    @Ignore("test runs on live db")
    @Test
    public void testGetMessageTypeFromLiveDB() {
        final MessageTypes messageTypes = new MessageTypes();
        assertNotNull(messageTypes.getMsgTypes());
    }
