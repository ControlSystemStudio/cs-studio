...
public class Activator extends AbstractUIPlugin {
    ...
    public void start(final BundleContext context) throws Exception {
        ...
        ServiceLocatorFactory
                .registerServiceWithTracker("Service to retrieve message types for archive table",
                                            context,
                                            IMessageTypes.class,
                                            new MessageTypes());
        ServiceLocatorFactory.registerServiceWithTracker("Service to access log message archive",
                                                         context,
                                                         ILogMessageArchiveAccess.class,
                                                         new ArchiveDBAccess());
    }
