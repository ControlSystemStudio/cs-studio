...
public class Activator extends AbstractCssUiPlugin {
    ...
    public void doStart(final BundleContext context) throws Exception {
        ...
        context.registerService(IMessageTypes.class.getName(), messageTypes, null);
        context.registerService(ILogMessageArchiveAccess.class.getName(), archiveAccess, null);
    }
