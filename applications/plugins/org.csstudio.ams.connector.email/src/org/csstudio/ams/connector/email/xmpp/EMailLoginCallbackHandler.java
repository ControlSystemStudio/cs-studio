...
package org.csstudio.ams.connector.email.xmpp;
 ...
 *
 */
public class EMailLoginCallbackHandler implements ILoginCallbackHandler
{
    ...
    {
        return new Credentials("ams-mail-connector", "ams");
    }
