...
public class EMailConnectorStart implements IApplication, IGenericServiceListener<ISessionService>
{
                ...
                if (actSynch.getStatus() != lastStatus)                         // if status value changed
                {
                    switch (actSynch.getStatus())
                    {
                        ...
                        case STAT_OK:
                            ...
                            break;
                        case STAT_ERR_EMAIL:
                        case STAT_ERR_EMAIL_SEND:
                            statustext = "err_email";
                            break;
    ...
    private boolean initJms()
    {
        try
        {
            ...
            extConnection.setClientID("EMailConnectorStartSenderExternal");
    ...
    private boolean sendStatusChange(int status, String strStat, long lSetTime) throws Exception
    {
        ...
        mapMsg.setString(AmsConstants.MSGPROP_CHECK_PLUGINID, EMailConnectorPlugin.PLUGIN_ID);
