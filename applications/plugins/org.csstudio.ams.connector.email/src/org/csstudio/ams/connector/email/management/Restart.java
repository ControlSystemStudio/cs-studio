...
public class Restart implements IManagementCommand
{
    ...
    {
        String password = (String)parameters.get("org.csstudio.ams.connector.email.param.Password");
        if(password == null)
        {
        ...
        return CommandResult.createMessageResult("Restarting application EMailConnector");
    }
}
