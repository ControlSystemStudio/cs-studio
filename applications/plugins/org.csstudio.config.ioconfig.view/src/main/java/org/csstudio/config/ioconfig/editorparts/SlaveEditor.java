...
public class SlaveEditor extends AbstractNodeEditor {
    ...
    class RowNumLabelProvider implements ITableLabelProvider {
         ...
         */
        @Nullable
        private String onModule(@Nonnull final Module module, final int columnIndex) {
            switch (columnIndex) {
                case 0:
         ...
         */
        @Nullable
        private String onSlave(@Nonnull final Slave slave, final int columnIndex) {
