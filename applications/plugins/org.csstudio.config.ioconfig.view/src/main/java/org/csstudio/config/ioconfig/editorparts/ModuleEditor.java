    ...
    private final class ISelectionChangedListenerForModuleTypeList implements
        ...
        public void selectionChanged(@Nonnull final SelectionChangedEvent event) {
            ...
            try {
                ...
                // TODO: (hrickens) Besseres Händling des Speicherns.
                e.printStackTrace();
            }
        ...
        private boolean ifSameModule(@Nullable final GsdModuleModel selectedModule) {
            return ( (selectedModule == null) || (_module == null) || ( (_module.getGSDModule() != null) && (_module
                    .getGSDModule().getModuleId() == selectedModule.getModuleNumber())));
        }

        private void makeNewChannel(@Nonnull final ModuleChannelPrototype channelPrototype,
                                    final int sortIndex) {
        ...
        private void makeStructChannel(@Nonnull final ModuleChannelPrototype channelPrototype,
                                       final int sortIndex) {
            ...
            ChannelStructure channelStructure = ChannelStructure
                    .makeChannelStructure(_module, channelPrototype.isInput(), channelPrototype
        ...
        private void makeNewPureChannel(@Nonnull final ModuleChannelPrototype channelPrototype,
                                        final int sortIndex) {
            Date now = new Date();
            String createdBy = "Unknown";
            User user = SecurityFacade.getInstance().getCurrentUser();
