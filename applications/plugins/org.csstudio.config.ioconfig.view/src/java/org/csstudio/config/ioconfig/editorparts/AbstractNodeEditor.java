...
public abstract class AbstractNodeEditor extends EditorPart implements INodeConfig {
    ...
    private TableViewer createChooserArea(final int columnNum,@Nonnull final Composite comp) {
        ...
        _gsdFiles = Repository.load(GSDFileDBO.class);
        if (_gsdFiles == null) {
            _gsdFiles = new ArrayList<GSDFileDBO>();
        } else if (!_gsdFiles.isEmpty()) {
            gsdFileTableViewer.setInput(_gsdFiles.toArray(new GSDFileDBO[_gsdFiles.size()]));
        }
    ...
    private final class GSDFileChangeListener implements
        ...
        public void selectionChanged(final SelectionChangedEvent event) {
            ...
            GSDFileDBO file = (GSDFileDBO) selection.getFirstElement();
    ...
    private final class GSDFileRemoveListener implements SelectionListener {
        ...
        public void widgetSelected(final SelectionEvent e) {
            ...
            GSDFileDBO removeFile = (GSDFileDBO) selection.getFirstElement();
            ...
            if (fd.open() != null) {
                ...
                for (String fileName : fd.getFileNames()) {
                    if (fileNotContain(fileName)) {
                        ...
                        GSDFileDBO gsdFile = new GSDFileDBO(file.getName(), text.toString());
    ...
    private final class GSDFileSelectionListener implements SelectionListener {
        ...
        private void doFileAdd() {
            _gsdFile = (GSDFileDBO) ((StructuredSelection) _tableViewer.getSelection())
                    .getFirstElement();
            if (fill(_gsdFile)) {
    ...
    private final class ViewerSorterExtension extends ViewerSorter {
        ...
        public int compare(final Viewer viewer, final Object e1, final Object e2) {
            if ( (e1 instanceof GSDFileDBO) && (e2 instanceof GSDFileDBO)) {
                GSDFileDBO file1 = (GSDFileDBO) e1;
                GSDFileDBO file2 = (GSDFileDBO) e2;
    ...
    private final class IconChooserDialog extends Dialog {
        ...
        private IconChooserDialog(@Nonnull final Shell parentShell, @Nonnull final AbstractNodeDBO node) {
            super(parentShell);
