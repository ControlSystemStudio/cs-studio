 ...
 * @since 06.06.2007
 */
public class ChannelConfigComposite extends AbstractNodeConfig {
    ...
    /**
     * Open a channel configuration view for a exist {@link ChannelDBO}.
     *
     * @param parent
    ...
    private void general(final String head) {
        ...
        if ((_channel.getIoName() != null) && !_channel.getIoName().isEmpty()) {
            List<SensorsDBO> loadSensors = Repository.loadSensors(_channel.getIoName());
...
//        assembleButton.setLayoutData(new GridData(SWT.BEGINNING, SWT.CENTER, false, false));
        ...
        assembleButton.addSelectionListener(new SelectionListener() {
            ...
            private void doAssemble() {
                GSDModuleDBO module = _channel.getModule().getGSDModule();
                ...
                ModuleChannelPrototypeDBO moduleChannelPrototype = array[_channel
    ...
    /**
     * Store all Data in {@link ChannelDBO} DB object.
     */
    ...
    public final AbstractNodeDBO getNode() {
        if (_channel == null) {
            ...
            if (selection.getFirstElement() instanceof ModuleDBO) {
                ModuleDBO module = (ModuleDBO) selection.getFirstElement();
                _channel = ChannelStructureDBO.makeSimpleChannel(module, false).getFirstChannel();
            }
