...
public class SearchDialog extends Dialog {
    ...
    private final class NameViewerFilter extends ViewerFilter {
        ...
        private boolean checkNodeName(SearchNodeDBO node) {
    ...
    private final class IONameViewerFilter extends ViewerFilter {
        ...
        private boolean checkNodeIOName(SearchNodeDBO node) {
    ...
    private final class EpicsAddressViewerFilter extends ViewerFilter {
        ...
        private boolean checkNodeEpicsAddress(SearchNodeDBO node) {
...
//        setShellStyle(SWT.RESIZE | parentShell.getStyle() | SWT.PRIMARY_MODAL);
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        columnCreateOn.setLabelProvider(new CellLabelProvider() {
            public void update(ViewerCell cell) {
                if (cell.getElement() instanceof SearchNodeDBO) {
                    Date createdOn = ((SearchNodeDBO) cell.getElement()).getCreatedOn();
                    if (createdOn != null) {
        ...
        columnUpdatedOn.setLabelProvider(new CellLabelProvider() {
            public void update(ViewerCell cell) {
                if (cell.getElement() instanceof SearchNodeDBO) {
                    Date updatedOn = ((SearchNodeDBO) cell.getElement()).getUpdatedOn();
                    if (updatedOn != null) {
        ...
        columnParentId.setLabelProvider(new CellLabelProvider() {
            public void update(ViewerCell cell) {
                if (cell.getElement() instanceof SearchNodeDBO) {
                    Integer id = ((SearchNodeDBO) cell.getElement()).getParentId();
                    if (id != null) {
                        cell.setText(id.toString());
                    }
                }
        ...
        resultTableView.addSelectionChangedListener(new ISelectionChangedListener() {
            public void selectionChanged(SelectionChangedEvent event) {
                ...
                _searchNode = (SearchNodeDBO) selection.getFirstElement();
                if (_searchNode != null) {
...
//        columnParentId.getColumn().pack();
    ...
    public SearchNodeDBO getSelectedNode() {
        return _searchNode;
    }
    ...
    protected void okPressed() {
        if (_selectedNode == null && _selectedId != null && _selectedId > 0) {
            ...
            if (openQuestion) {
                _selectedNode = Repository.load(AbstractNodeDBO.class, _selectedId);
                if (_selectedNode != null) {
                    AbstractNodeDBO parentNode = _selectedNode;
                    while (!parentNode.isRootNode()) {
                        parentNode = parentNode.getParent();
                    }
                    List<FacilityDBO> input = (List<FacilityDBO>)_profiBusTreeView.getTreeViewer().getInput();
