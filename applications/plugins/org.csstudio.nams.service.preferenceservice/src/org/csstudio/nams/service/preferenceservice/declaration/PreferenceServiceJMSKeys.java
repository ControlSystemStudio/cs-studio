...
public enum PreferenceServiceJMSKeys implements HoldsAPreferenceId {
	P_JMS_EXTERN_CONNECTION_FACTORY("org.csstudio.ams.preferences.jmsExternConnectionFactory", "deprecated preference - backward compatibility (P_JMS_EXTERN_CONNECTION_FACTORY)"),
	P_JMS_EXTERN_CONNECTION_FACTORY_CLASS("org.csstudio.ams.preferences.jmsExternConnectionFactoryClass", "Internal connection factory class"),
	...
	P_JMS_AMS_TOPIC_COMMAND("org.csstudio.ams.preferences.jmsAmsTopicCommand", "Command exchange topic"),
	...
	P_JMS_AMS_PROVIDER_URL_1("org.csstudio.ams.preferences.jmsAmsProviderUrl1", "First provider URL"),
	P_JMS_AMS_PROVIDER_URL_2("org.csstudio.ams.preferences.jmsAmsProviderUrl2", "Second provider URL"),
	P_JMS_AMS_SENDER_PROVIDER_URL("org.csstudio.ams.preferences.jmsAmsSenderProviderUrl", "Sender provider URL"), 
	
	P_JMS_AMS_TOPIC_COMMAND_DECISSION_DEPARTMENT_SUBSCRIBER_ID("org.csstudio.ams.preferences.jmsAmsTSubCmdFmrReloadEnd","Subscriber ID of decission department to recieve commands");
