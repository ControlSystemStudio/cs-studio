...
public final class Messages {
    ...
    public static final String HTTP_NO_ERROR = "Ok";
    public static final String HTTP_CHANNEL = "Channel";
    public static final String HTTP_COLUMN_CHANNEL_COUNT = "Channels";
    public static final String HTTP_CHANNEL_INFO = "Channel Info";
    public static final String HTTP_CHANNELS = "Channels";
    public static final String HTTP_COLUMN_CONNECTED = "Connected";
