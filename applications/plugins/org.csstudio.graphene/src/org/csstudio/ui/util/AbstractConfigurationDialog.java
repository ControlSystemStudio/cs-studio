...
/**
 * Root of all the dialogs which will take a ConfigurableWidget and configure it based on the related
 * ConfigurableComposite. Represents a dialog that embeds the ConfigurableComposite, the Apply/Cancel
 * buttons and includes the logic to forward the change notifications to the widget.
 * 
 * @author Gabriele Carcassi
 *
 * @param <Widget> the type of the widget to be configured
 * @param <ConfigurationComposite> the composite that will configure the widget
 */
public abstract class AbstractConfigurationDialog<Widget extends Composite & ConfigurableWidget,
ConfigurationComposite extends AbstractConfigurationPanel> extends Dialog {
