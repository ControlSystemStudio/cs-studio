...
public class HistogramView extends ViewPart {
	 ...
	 */
	public static final String ID = "org.csstudio.graphene.WaterfallView";
	...
	public void setProcessVariable(ProcessVariable processVariable) {
		...
		histogramWidget.setProcessVariable(processVariable);
	}
	...
	public void createPartControl(Composite parent) {
		...
		inputBar.addPropertyChangeListener(new PropertyChangeListener() {
			...
			public void propertyChange(PropertyChangeEvent event) {
				if ("processVariable".equals(event.getPropertyName())) {
					histogramWidget.setProcessVariable(inputBar.getProcessVariable());
				}
			}
		});
		
		histogramWidget = new HistogramWidget(parent, SWT.NONE);
		...
		histogramWidget.setLayoutData(fd_waterfallComposite);
