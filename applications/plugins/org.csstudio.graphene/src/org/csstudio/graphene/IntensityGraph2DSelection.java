 ...
 *
 */
public class IntensityGraph2DSelection implements VTypeAdaptable,
        ProcessVariableAdaptable,
        ConfigurableWidgetAdaptable {

    private final IntensityGraph2DWidget widget;

    public IntensityGraph2DSelection(IntensityGraph2DWidget widget) {
        this.widget = widget;
    }
