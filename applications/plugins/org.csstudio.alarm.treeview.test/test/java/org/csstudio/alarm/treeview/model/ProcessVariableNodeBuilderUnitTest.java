 ...
 * @author jpenning
 */
public class ProcessVariableNodeBuilderUnitTest {
    ...
    public void testBuilder() {
        ...
        ProcessVariableNode node = builder.build();
        Assert.assertEquals("node0", node.getName());
        Assert.assertEquals(TreeNodeSource.LDAP, node.getSource());
        Assert.assertSame(alarm, node.getHighestUnacknowledgedAlarm());
    }
    ...
    public void testBuildAddsTwoEqualNodes() {
        ...
        ProcessVariableNode node0 = new ProcessVariableNode.Builder("node0", TreeNodeSource.LDAP)
                .setParent(parent).build();
        ProcessVariableNode node1 = new ProcessVariableNode.Builder("node1", TreeNodeSource.LDAP)
                .setParent(parent).build();
        ...
        new ProcessVariableNode.Builder("node0", TreeNodeSource.LDAP).setParent(parent).build();
    }
