...
final class ChangelogEntrySerializer {
	 ...
	 */
	static String serialize(final ChangelogEntry entry) {
	 ...
	 */
	static ChangelogEntry deserialize(final String serialized) {
	 ...
	 */
	// CHECKSTYLE:OFF
	static String[] splitAndUnescape(final String string) {
