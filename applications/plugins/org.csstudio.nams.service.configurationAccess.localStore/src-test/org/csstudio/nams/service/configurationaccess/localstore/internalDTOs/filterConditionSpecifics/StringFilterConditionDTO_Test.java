...
public class StringFilterConditionDTO_Test extends AbstractObject_TestCase<StringFilterConditionDTO> {
	...
	protected StringFilterConditionDTO[] getThreeDiffrentNewInstanceOfClassUnderTest() {
		StringFilterConditionDTO[] neueFilterConditions = new StringFilterConditionDTO[3];
		...
		neueFilterConditions[0].setOperatorEnum(StringRegelOperator.OPERATOR_TEXT_EQUAL);
		...
		neueFilterConditions[1].setOperatorEnum(StringRegelOperator.OPERATOR_NUMERIC_GT_EQUAL);
		...
		neueFilterConditions[2].setOperatorEnum(StringRegelOperator.OPERATOR_NUMERIC_LT_EQUAL);
