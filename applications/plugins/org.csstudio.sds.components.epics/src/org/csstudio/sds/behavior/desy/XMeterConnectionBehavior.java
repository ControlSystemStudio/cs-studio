...
/**
 * Default DESY-Behavior for the {@link XMeterModel} widget with Connection state
 *
 * @author hrickens
 * @author $Author$
 * @version $Revision$
 * @since 20.04.2010
 */
public class XMeterConnectionBehavior extends AbstractDesyConnectionBehavior<XMeterModel> {

    /**
     * Constructor.
     */
    public XMeterConnectionBehavior() {
