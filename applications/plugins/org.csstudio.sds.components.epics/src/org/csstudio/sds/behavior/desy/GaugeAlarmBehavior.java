...
/**
 *
 * Default DESY-Behavior for the {@link GaugeModel} widget with Connection state and Alarms.
 *
 * @author hrickens
 * @author $Author$
 * @version $Revision$
 * @since 20.04.2010
 */
public class GaugeAlarmBehavior extends AbstractDesyAlarmBehavior<GaugeModel> {
