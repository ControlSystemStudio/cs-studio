...
/**
 *
 * Default DESY-Behavior for the {@link ThumbWheelModel} widget with Connection state and Alarms.
 *
 * @author hrickens
 ...
 * @since 20.04.2010
 */
public class ThumbWheelAlarmBehavior extends AbstractDesyAlarmBehavior<ThumbWheelModel> {

    /**
     * Constructor.
     */
    public ThumbWheelAlarmBehavior() {
