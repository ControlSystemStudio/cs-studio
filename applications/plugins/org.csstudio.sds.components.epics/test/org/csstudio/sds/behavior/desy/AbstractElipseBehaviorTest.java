 ...
 * @since 26.10.2011
 */
public abstract class AbstractElipseBehaviorTest<B extends AbstractBehavior<AbstractWidgetModel>> extends AbstractBehaviorTest<AbstractWidgetModel, B> {


    @Override
    protected EllipseModel createModelMock() {
        final EllipseModel mock = mock(EllipseModel.class);
