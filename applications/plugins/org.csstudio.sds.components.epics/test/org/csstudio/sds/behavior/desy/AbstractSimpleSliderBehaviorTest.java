 ...
 * @since 26.10.2011
 */
public abstract class AbstractSimpleSliderBehaviorTest<B extends AbstractBehavior<SimpleSliderModel>> extends AbstractBehaviorTest<SimpleSliderModel, B> {


    @Override
    protected SimpleSliderModel createModelMock() {
        final SimpleSliderModel mock = mock(SimpleSliderModel.class);
