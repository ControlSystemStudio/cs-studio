...
public class PasswordEditor extends FieldEditor {
     ...
     */
    public PasswordEditor(String name, String labelText, int width,
     ...
     * @param width			int
     * @param parent		Composite
     * @see #PasswordEditor(String, String, int, int, Composite)
     */
    public PasswordEditor(String name, String labelText, int width,
            Composite parent)
    {
     ...
     * @param labelText		String
     * @param parent		Composite
     * @see #PasswordEditor(String, String, int, Composite)
     */
    public PasswordEditor(String name, String labelText, Composite parent)
    {
