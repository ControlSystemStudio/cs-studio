 ...
 */
public class FilterConditionArrayStringValuesTObject extends TObject
{
	private static final long serialVersionUID = -5130841627445555112L;
	
	private int 	filterConditionRef;
	private String 	compValue;

	public FilterConditionArrayStringValuesTObject()
	{
		this.filterConditionRef = -1;
	}
	
	public FilterConditionArrayStringValuesTObject(int filterConditionRef, String compValue)
	{
	...
	{
		if(!(obj instanceof FilterConditionArrayStringValuesTObject))
			return false;
		
		FilterConditionArrayStringValuesTObject compare = (FilterConditionArrayStringValuesTObject)obj;
