 ...
 *
 */
public class FilterCondFilterCondTObject
{
    public int filterConditionId;
    public int filterConditionRef;
    ...
    */
    ...
    public FilterCondFilterCondTObject()
    {
        filterConditionId = -1;
        filterConditionRef = -1;
    }
    
    public FilterCondFilterCondTObject(int filterConditionID, int filterConditionRef)
    {
    ...
    {
        if(!(obj instanceof FilterCondFilterCondTObject))
            return false;
        
        FilterCondFilterCondTObject compare = (FilterCondFilterCondTObject)obj;
