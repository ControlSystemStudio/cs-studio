...
*/
public class FilterFilterConditionTObject
{

	private int filterRef;// PRIMARY KEY (Part 1/2)
	private int filterConditionRef;// PRIMARY KEY (Part 2/2)
	private int pos;
	
	public FilterFilterConditionTObject()
	{
		this.filterRef = -1;
		this.filterConditionRef = -1;
	}

	public FilterFilterConditionTObject(int filterRef, int filterConditionRef, int pos)
	{
