...
public class ColumnViewerWeightedLayout extends ControlAdapter {
    ...
    public ColumnViewerWeightedLayout(final GridTableViewer gridTableViewer, final GridViewerColumn gridViewerColumn, final int weight, final int minWidth) {
    ...
    public void controlResized(final ControlEvent e) {
		...
		if (oldSize.x == 0 && oldSize.y == 0) {
		    ...
		    newWidth = gridViewerColumn.getColumn().getWidth() + (weight * (newSize.x - oldSize.x) / 100);
		}
