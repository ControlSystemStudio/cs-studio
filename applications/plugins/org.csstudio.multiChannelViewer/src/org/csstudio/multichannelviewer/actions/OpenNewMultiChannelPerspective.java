 ...
 *
 */
public class OpenNewMultiChannelPerspective extends AbstractHandler implements IHandler {

	@SuppressWarnings("deprecation")
	@Override
	public Object execute(ExecutionEvent event) throws ExecutionException {
		event.getApplicationContext();
		MultiChannelPlot.createInstance();
		...
		try {
			if (pref
				...
				workbench.openWorkbenchWindow(PerspectiveFactory.PERSPECTIVE_ID, null);
			else if (pref
