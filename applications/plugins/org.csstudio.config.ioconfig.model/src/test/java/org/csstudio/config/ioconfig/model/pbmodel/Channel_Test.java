...
public class Channel_Test {
    ...
    public void testGetEpicsAdressString() throws PersistenceException {
        _slave.moveSortIndex( 17);
        _slave.localSave();
        GSDFile gsdFile = new GSDFile("Test", _gsdFile);
        GSDModule gSDModule = new GSDModule();
        gSDModule.setModuleId(1);
        gSDModule.addModuleChannelPrototype(new ModuleChannelPrototype());
        ...
        Channel out = ChannelStructure.makeSimpleChannel(_module, false).getFirstChannel();
        out.assembleEpicsAddressString();
        assertNotNull(out.getEpicsAddressStringNH());
        assertTrue("@Subnet:17/0 'T=BIT'", out.getEpicsAddressStringNH().startsWith("@Subnet:17/0 'T="));
    }
    ...
    public void testInputAndOutputChannels() throws PersistenceException {
        ...
        channelM1C1.assembleEpicsAddressString();
    ...
    public void testTestOutputStructChannels() throws PersistenceException {
        ...
        assertEquals("Struct Channel: " + structChannel3, DataType.BIT, structChannel3
                .getChannelType());
        assertEquals(0, (int)structChannel3.getSortIndex());
        ...
        assertEquals("Struct Channel: " + structChannel3, DataType.BIT, structChannel3
                .getChannelType());
        assertEquals(1,(int) structChannel3.getSortIndex());
        assertEquals(1, structChannel3.getChSize());
        assertEquals(0, structChannel3.getChannelNumber());
        assertEquals(2, structChannel3.getFullChannelNumber());
        ...
        assertEquals("Struct Channel: " + structChannel3, DataType.BIT, structChannel3
                .getChannelType());
        assertEquals( 2,(int) structChannel3.getSortIndex());
        assertEquals(1, structChannel3.getChSize());
        assertEquals(0, structChannel3.getChannelNumber());
        assertEquals(2, structChannel3.getFullChannelNumber());
        ...
        assertEquals("Struct Channel: " + structChannel3, DataType.BIT, structChannel3
                .getChannelType());
        assertEquals(3,(int) structChannel3.getSortIndex());
        assertEquals(1, structChannel3.getChSize());
        assertEquals(0, structChannel3.getChannelNumber());
        assertEquals(2, structChannel3.getFullChannelNumber());
        ...
        assertEquals("Struct Channel: " + structChannel3, DataType.BIT, structChannel3
                .getChannelType());
        assertEquals(4,(int) structChannel3.getSortIndex());
        assertEquals(1, structChannel3.getChSize());
        assertEquals(0, structChannel3.getChannelNumber());
        assertEquals(2, structChannel3.getFullChannelNumber());
        ...
        assertEquals("Struct Channel: " + structChannel3, DataType.BIT, structChannel3
                .getChannelType());
        assertEquals(5,(int) structChannel3.getSortIndex());
        assertEquals(1, structChannel3.getChSize());
        assertEquals(0, structChannel3.getChannelNumber());
        assertEquals(2, structChannel3.getFullChannelNumber());
        ...
        assertEquals("Struct Channel: " + structChannel3, DataType.BIT, structChannel3
                .getChannelType());
        assertEquals(6,(int) structChannel3.getSortIndex());
        assertEquals(1, structChannel3.getChSize());
        assertEquals(0, structChannel3.getChannelNumber());
        assertEquals(2, structChannel3.getFullChannelNumber());
        ...
        assertEquals("Struct Channel: " + structChannel3, DataType.BIT, structChannel3
                .getChannelType());
        assertEquals(7,(int) structChannel3.getSortIndex());
        assertEquals(1, structChannel3.getChSize());
        assertEquals(0, structChannel3.getChannelNumber());
        assertEquals(2, structChannel3.getFullChannelNumber());
        ...
        assertEquals("Struct Channel: " + structChannel3, DataType.BIT, structChannel3
                .getChannelType());
        assertEquals(8,(int) structChannel3.getSortIndex());
        assertEquals(1, structChannel3.getChSize());
        assertEquals(0, structChannel3.getChannelNumber());
        assertEquals(2, structChannel3.getFullChannelNumber());
        ...
        assertEquals("Struct Channel: " + structChannel3, DataType.BIT, structChannel3
                .getChannelType());
        assertEquals(9,(int) structChannel3.getSortIndex());
        assertEquals(1, structChannel3.getChSize());
        assertEquals(0, structChannel3.getChannelNumber());
        assertEquals(2, structChannel3.getFullChannelNumber());
        ...
        assertEquals("Struct Channel: " + structChannel3, DataType.BIT, structChannel3
                .getChannelType());
        assertEquals(10,(int) structChannel3.getSortIndex());
        assertEquals(1, structChannel3.getChSize());
        assertEquals(0, structChannel3.getChannelNumber());
        assertEquals(2, structChannel3.getFullChannelNumber());
        ...
        assertEquals("Struct Channel: " + structChannel3, DataType.BIT, structChannel3
                .getChannelType());
        assertEquals(11,(int) structChannel3.getSortIndex());
        assertEquals(1, structChannel3.getChSize());
        assertEquals(0, structChannel3.getChannelNumber());
        assertEquals(2, structChannel3.getFullChannelNumber());
        ...
        assertEquals("Struct Channel: " + structChannel3, DataType.BIT, structChannel3
                .getChannelType());
        assertEquals(12,(int) structChannel3.getSortIndex());
        assertEquals(1, structChannel3.getChSize());
        assertEquals(0, structChannel3.getChannelNumber());
        assertEquals(2, structChannel3.getFullChannelNumber());
        ...
        assertEquals("Struct Channel: " + structChannel3, DataType.BIT, structChannel3
                .getChannelType());
        assertEquals(13,(int) structChannel3.getSortIndex());
        assertEquals(1, structChannel3.getChSize());
        assertEquals(0, structChannel3.getChannelNumber());
        assertEquals(2, structChannel3.getFullChannelNumber());
        ...
        assertEquals("Struct Channel: " + structChannel3, DataType.BIT, structChannel3
                .getChannelType());
        assertEquals(14,(int) structChannel3.getSortIndex());
        assertEquals(1, structChannel3.getChSize());
        assertEquals(0, structChannel3.getChannelNumber());
        assertEquals(2, structChannel3.getFullChannelNumber());
        ...
        assertEquals("Struct Channel: " + structChannel3, DataType.BIT, structChannel3
                .getChannelType());
        assertEquals(15,(int) structChannel3.getSortIndex());
        assertEquals(1, structChannel3.getChSize());
        assertEquals(0, structChannel3.getChannelNumber());
        assertEquals(2, structChannel3.getFullChannelNumber());
