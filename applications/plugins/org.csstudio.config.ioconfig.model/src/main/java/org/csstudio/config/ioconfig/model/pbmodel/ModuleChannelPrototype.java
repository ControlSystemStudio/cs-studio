...
public class ModuleChannelPrototype extends DBClass implements Comparable<ModuleChannelPrototype> {
    ...
    public void setGSDModule(GSDModule module) {
        _gSDModule = module;
    }
    ...
    public int compareTo(ModuleChannelPrototype other) {
