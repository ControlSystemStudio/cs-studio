...
public class ProfibusSubnet extends Node {
    ...
    /**
     * This Constructor is only used by Hibernate. To create an new {@link ProfibusSubnet}
     * {@link #ProfibusSubnet(Ioc)}
     */
    public ProfibusSubnet() {
    }
...
//    }
    ...
    public Set<Master> getProfibusDPMaster() {
        return (Set<Master>) getChildren();
    }
     ...
     */
    public void setIoc(final Ioc ioc) {
        this.setParent(ioc);
    }
