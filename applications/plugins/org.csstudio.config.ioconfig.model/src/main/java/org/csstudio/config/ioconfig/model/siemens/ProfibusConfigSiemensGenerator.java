...
public class ProfibusConfigSiemensGenerator {
    ...
    */
     ...
     *
     */
    private void createSlave(final Slave slave) {
        ...
        _fileInput.append("END")
                  .append(LINE_END)
                  .append(LINE_END);
        Set<Module> modules = slave.getModules();
     ...
     * @param module
     */
    private void createModule(final Module module, final int fdlAddress) {
        _fileInput.append("DPSUBSYSTEM 1, ")
                  .append("DPADDRESS ")
                  .append(fdlAddress + ", ")
                  .append("SLOT ")
