...
public class DummyRepository implements IRepository {
    ...
    @CheckForNull
    public List<Integer> getRootPath(@Nullable final int id) {
        return null;
    }
    ...
    @CheckForNull
    public GSDModuleDBO saveWithChildren(@Nullable final GSDModuleDBO gsdModule) throws PersistenceException {
        return null;
    }
