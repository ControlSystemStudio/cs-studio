...
package org.csstudio.ams.application.monitor.management;

import java.util.Arrays;
import java.util.List;

import org.csstudio.ams.application.monitor.AmsMonitorActivator;
import org.csstudio.ams.application.monitor.RemotelyManageable;
...
public class Restart implements IManagementCommand {
    ...
    public CommandResult execute(CommandParameters parameters) {
        ...
        BundleContext bundleContext = AmsMonitorActivator.getContext();

        String serviceFilter = "(&(objectClass=" +
        ApplicationHandle.class.getName() + ")"
        + "(application.descriptor=" + AmsMonitorActivator.PLUGIN_ID + "*))";
        ...
        try {
            ...
            if(allServices != null) {
                ...
                for(ApplicationHandle o : regApps) {
                    ...
                    if(o.getInstanceId().contains("AmsSystemMonitorApplication")) {
                        thisHandle = o;
                        break;
                    }
                }
        ...
        if(thisHandle != null) {
            ...
            result = CommandResult.createMessageResult("OK: [0] - Restarting AmsSystemMonitorApplication...");
            thisHandle.destroy();
        } else {
