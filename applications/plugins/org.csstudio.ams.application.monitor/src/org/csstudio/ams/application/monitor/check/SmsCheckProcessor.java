 ...
 * @since 11.04.2012
 */
public class SmsCheckProcessor extends AbstractCheckProcessor implements MessageListener {
    ...
    public SmsCheckProcessor(String subscriberName, String ws) {
        this(subscriberName, ws, 0L);
    }
    
    public SmsCheckProcessor(String subscriberName, String ws, long interval) {
    ...
    public void run() {
        ...
        Enumeration<DeliveryWorkerAnswerMessage> elements = messageQueue.elements();
        while (elements.hasMoreElements()) {
            DeliveryWorkerAnswerMessage o = elements.nextElement();
