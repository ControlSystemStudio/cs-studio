 ...
 *
 */
public class AmsMonitorException extends Exception {
    ...
    public static final int ERROR_CODE_JMS = 16;
    public static final int ERROR_CODE_TIMEOUT = 32;
    
    public AmsMonitorException() {
        super();
        this.errorCode = ERROR_CODE_UNDEFINED;
    }
    
    public AmsMonitorException(final String message) {
        super(message);
        this.errorCode = ERROR_CODE_UNDEFINED;
    }

    public AmsMonitorException(final String message, final Throwable cause)  {
        super(message, cause);
        this.errorCode = ERROR_CODE_UNDEFINED;
    }

    public AmsMonitorException(final Throwable cause) {
        super(cause);
        this.errorCode = ERROR_CODE_UNDEFINED;
    }
    
    public AmsMonitorException(final int error) {
        super();
        this.errorCode = error;
    }
    
    public AmsMonitorException(final String message, final int error) {
        super(message);
        this.errorCode = error;
    }
    ...
    public AmsMonitorException(final Throwable cause, final int error) {
        super(cause);
        this.errorCode = error;
    }
