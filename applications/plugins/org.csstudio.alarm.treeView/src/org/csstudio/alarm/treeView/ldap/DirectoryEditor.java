...
public final class DirectoryEditor {
    ...
    public static void modifyHelpPage(@Nonnull final AbstractAlarmTreeNode node,
        ...
        modifyAttribute(node, "epicsHelpPage", value != null ? value.toString() : null);
     ...
     *             if an error occurs.
     */
    public static void copyNode(@Nonnull final IAlarmTreeNode node, @Nonnull final SubtreeNode target)
    throws DirectoryEditException {
     ...
     *             if an error occurs.
     */
    private static void copySubtree(@Nonnull final SubtreeNode node, @Nonnull final SubtreeNode target)
    throws DirectoryEditException {
     ...
     */
    private static void copyChildren(@Nonnull final SubtreeNode node, @Nonnull final SubtreeNode target)
    throws DirectoryEditException {
        for (final IAlarmTreeNode child : node.getChildren()) {
     ...
     *             if an error occurs.
     */
    private static void copyProcessVariableNode(@Nonnull final ProcessVariableNode node,
