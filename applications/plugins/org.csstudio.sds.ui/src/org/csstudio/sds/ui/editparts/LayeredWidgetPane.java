...
public final class LayeredWidgetPane extends FreeformLayeredPane {
	...
	/**
	 * Constructor.
	 * @param showBorder Show the border?
	 */
...
//		};
	 ...
	 * @param showBorder True if the border should be shown, false otherwise
	 */
	...
	public void setBorderBounds(final int width, final int height) {
		...
		_backgroundFigure.setLocation(new Point(_borderBounds.width-1,_borderBounds.height-1));
//		_backgroundFigure.setBounds(_borderBounds);
	}
	
	/**
	 * Sets the visibility of the Layer specified by the given layerId to <i>visible</i>.
	 * @param layerId
	 * 			The id of the Layer
	 * @param visible
...
//		add(layer, layerId, newIndex);
	...
	/**
	 * Adds the given IFigure at the given index and inserts the IFigure to
	 * the Layer specified by the given layerId.
	 * @param layerId
	 * 			The id of the Layer
	 * @param widgetFigure
	...
	public void addWidget(final String layerId, final IFigure widgetFigure,
		...
		//TODO: Performanter implementieren
...
//		int counter = 0;
//		while (counter<widgetsInLayer.size() && _widgetFigures.indexOf(widgetsInLayer.get(counter))<index) {
//			counter++;
//		}
//		layer.add(widgetFigure, counter);
	}
...
//	}
	...
	/**
	 * Adds a new Layer with the given <i>layerName</i> at the given index to this Pane.
	 * @param layerName
...
//					add(layer, layerName, index);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public void removeLayer(final String layerName, final String fallBackLayerName) {
	...
	/**
	 * Moves the given IFigure from the Layer specified by the <i>oldLayerName</i> to
	 * the Layer specified by the <i>newLayerName</i>.
	 * @param figure
