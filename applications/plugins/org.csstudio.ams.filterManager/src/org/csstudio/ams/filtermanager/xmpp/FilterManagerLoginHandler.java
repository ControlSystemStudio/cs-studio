...
package org.csstudio.ams.filtermanager.xmpp;
 ...
 *
 */
public class FilterManagerLoginHandler implements ILoginCallbackHandler
{
    /* (non-Javadoc)
    ...
    {
        return new Credentials("ams-filter-manager", "ams");
    }
