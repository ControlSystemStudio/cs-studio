...
public class LdapResultListObserver implements Observer {
	...
	public synchronized void update(final Observable o, final Object arg) {
		if (!(o instanceof LdapResultList)) {
			throw new IllegalArgumentException("Observed object must be of type LdapResultList");
		}

        final List<String> l = ((LdapResultList) o).getAnswer();
        final String answerLDAP = l.get(0);
