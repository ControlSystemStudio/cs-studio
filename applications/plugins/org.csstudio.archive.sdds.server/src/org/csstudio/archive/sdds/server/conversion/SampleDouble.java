...
public class SampleDouble
{
     ...
     * @param value
     */
    public SampleDouble(final long timeSec, final long timeUSec, final long status, final long dim, final DoubleValue value)
    {
    ...
    public void setTimeSec(final long timeSec)
    {
        this.timeSec = timeSec;
    }
    ...
    public void setTimeUSec(final long timeUSec)
    {
        this.timeUSec = timeUSec;
    }
