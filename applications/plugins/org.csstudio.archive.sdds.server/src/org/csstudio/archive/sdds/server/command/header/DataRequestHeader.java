...
public class DataRequestHeader implements IRequestHeader
{
     ...
     * @param data
     */
    public DataRequestHeader(byte[] data)
    {
     ...
     * @throws IOException
     */
    private String readNextString(DataInputStream d) throws IOException
    {
     ...
     * @param fromUSec
     */
    public void setFromUSec(int fromUSec)
    {
     ...
     * @param toUSec
     */
    public void setToUSec(int toUSec)
    {
        this.toUSec = toUSec;
    }
     ...
     */
    public void setMaxNumOfSamples(int maxNumOfSamples)
    {
     ...
     */
    public void setConversionParameter(double conversionParameter)
    {
     ...
     * @param pvNameSize
     */
    public void setPvNameSize(int pvNameSize)
    {
