...
/**
 * Test for TimeBasedRegelAlarmBeiBestätigung
 * 
 * 
...
public class TimeBasedRegelAlarmBeiBestaetigung_Test extends
		AbstractObject_TestCase<TimeBasedAlarmBeiBestaetigungRegel> {
	...
	public void testPruefeNachrichtAufBestaetigungsUndAufhebungsNachrichtAufBereitsFertigNichtZutreffend() {
		...
		final TimeBasedAlarmBeiBestaetigungRegel timeBasedRegel = new TimeBasedAlarmBeiBestaetigungRegel(
				this._ausloesungsRegel, regel, Millisekunden.valueOf(100));
	...
	public void testPruefeNachrichtAufBestaetigungsUndAufhebungsNachrichtAufNichtOK() {
		...
		final TimeBasedAlarmBeiBestaetigungRegel timeBasedRegel = new TimeBasedAlarmBeiBestaetigungRegel(
				this._ausloesungsRegel, bestaetigungsRegel, Millisekunden
						.valueOf(100));
	...
	public void testPruefeNachrichtAufBestaetigungsUndAufhebungsNachrichtAufOK() {
		...
		final TimeBasedAlarmBeiBestaetigungRegel timeBasedRegel = this
	...
	public void testPruefeNachrichtAufTimeOutsBevorTimeOut() {
		...
		final TimeBasedAlarmBeiBestaetigungRegel tbRegel = this
				.getNewInstanceOfClassUnderTest();
	...
	public void testPruefeNachrichtErstmaligAusloesungNichtZutreffend() {
		...
		final TimeBasedAlarmBeiBestaetigungRegel tbRegel = new TimeBasedAlarmBeiBestaetigungRegel(
				ausloesungsRegel, this._bestaetigungsRegel, Millisekunden
						.valueOf(100));
	...
	protected TimeBasedAlarmBeiBestaetigungRegel getNewInstanceOfClassUnderTest() {
		return new TimeBasedAlarmBeiBestaetigungRegel(this._ausloesungsRegel,
				this._bestaetigungsRegel, Millisekunden.valueOf(100));
	}
	...
	protected TimeBasedAlarmBeiBestaetigungRegel[] getThreeDiffrentNewInstanceOfClassUnderTest() {
		final TimeBasedAlarmBeiBestaetigungRegel[] result = new TimeBasedAlarmBeiBestaetigungRegel[3];
		result[0] = new TimeBasedAlarmBeiBestaetigungRegel(
				this._ausloesungsRegel, this._bestaetigungsRegel, Millisekunden
						.valueOf(100));
		result[1] = new TimeBasedAlarmBeiBestaetigungRegel(
				this._ausloesungsRegel, this._bestaetigungsRegel, Millisekunden
						.valueOf(300));
		result[2] = new TimeBasedAlarmBeiBestaetigungRegel(
				this._ausloesungsRegel, this._bestaetigungsRegel, Millisekunden
						.valueOf(500));
		return result;
	}
