...
public class Restart implements IManagementCommand {
    ...
    public CommandResult execute(CommandParameters parameters) {
        ...
        String password = SmsConnectorStart.getInstance().getPassword();
        ...
        int lastState = SmsConnectorStart.getInstance().getStatus();
        SmsConnectorStart.getInstance().setRestart();

        return CommandResult.createMessageResult("Last state: " + SmsConnectorStart.STATE_TEXT[lastState] + "\n\nRestarting application");
    }
}
