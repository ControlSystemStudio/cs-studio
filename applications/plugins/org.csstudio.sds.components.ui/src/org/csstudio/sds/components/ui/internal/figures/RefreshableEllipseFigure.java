 ...
 * 
 */
public final class RefreshableEllipseFigure extends Ellipse implements ICrossedFigure {
    ...
    public void setCrossedOut(boolean crossed) {
        _crossedPaintHelper.setCrossed(crossed);
    }
}
