...
public class TunerWidget extends AbstractChannelQueryResultWidget implements
	...
	labelVertical = new Label(this, SWT.SEPARATOR | SWT.VERTICAL);
	labelVertical.addMouseMoveListener(new MouseMoveListener() {
	    public void mouseMove(MouseEvent e) {
		FormData fd = (FormData) labelVertical.getLayoutData();
		...
		labelVertical.setLayoutData(fd);
		labelVertical.getParent().layout();
	    }
	});
	labelVertical.setCursor(Display.getCurrent().getSystemCursor(
		SWT.CURSOR_SIZEWE));
	FormData fd_labelVertical = new FormData();
	fd_labelVertical.left = new FormAttachment(70);
	fd_labelVertical.top = new FormAttachment(errorBar, 2);
	fd_labelVertical.bottom = new FormAttachment(100, -70);
	labelVertical.setLayoutData(fd_labelVertical);
	...
	fd_channelTableComposite.right = new FormAttachment(labelVertical, -1);
	...
	channelTableViewer = new TableViewer(channelTableComposite, SWT.BORDER
		| SWT.FULL_SELECTION | SWT.MULTI | SWT.DOUBLE_BUFFERED);
	...
	fd_stepValueTable.bottom = new FormAttachment(channelTableComposite, 0,
		SWT.BOTTOM);
	fd_stepValueTable.left = new FormAttachment(labelVertical, 1);
	...
	setpointTableViewer = new TableViewer(stepTableComposite, SWT.BORDER
		| SWT.FULL_SELECTION | SWT.DOUBLE_BUFFERED);
	setpointTableViewer
	...
	fd_btnGenerate.right = new FormAttachment(100, -2);
