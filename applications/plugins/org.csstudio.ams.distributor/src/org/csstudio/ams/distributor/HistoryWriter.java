...
class HistoryWriter {
    ...
    static void logHistoryRplStart(Connection conDb, boolean bStart) {
    	try {
    ...
    static void logHistorySend(java.sql.Connection conDb,
    ...
    // SQLException
    {
    	String msgHost = mapMsg.getString(AmsConstants.MSGPROP_HOST);
    	String msgProc = mapMsg.getString(AmsConstants.MSGPROP_PROCESSID);
    	String msgName = mapMsg.getString(AmsConstants.MSGPROP_NAME);
    	String msgEventTime = mapMsg.getString(AmsConstants.MSGPROP_EVENTTIME);
    ...
    static void logHistoryGroupBlocked(java.sql.Connection conDb,
    ...
    static void logHistoryReply(java.sql.Connection conDb,
    ...
    static void logHistoryChangeStatus(java.sql.Connection conDb,
