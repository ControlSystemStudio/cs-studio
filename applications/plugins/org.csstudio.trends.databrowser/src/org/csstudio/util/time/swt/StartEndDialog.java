...
public class StartEndDialog extends Dialog implements TimestampWidgetListener
{
    ...
    */
    ...
    protected Control createDialogArea(Composite parent)
    {
        ...
        start_widget = new TimestampWidget(left, 0);
        // TODO start_widget = new TimestampWidget(left, 0, start);
        ...
        end_widget = new TimestampWidget(right, 0);
        // TODO end_widget = new TimestampWidget(right, 0, end);
