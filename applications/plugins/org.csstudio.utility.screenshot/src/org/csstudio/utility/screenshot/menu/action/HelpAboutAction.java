...
import org.csstudio.utility.screenshot.dialog.AboutDialog;
...
public class HelpAboutAction extends Action
{
    ...
    public HelpAboutAction(ScreenshotWorker w)
    {
        worker = w;
        
        this.setText("About");

        this.setToolTipText("Some informations.");
    ...
    public void run()
    {
        AboutDialog ad = new AboutDialog(ScreenshotPlugin.getDefault().getDisplay().getActiveShell());
