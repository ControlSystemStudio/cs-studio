...
public class AxisRangeProperty extends AbstractWidgetProperty {
	...
	public void writeToXML(Element propElement) {
		...
		if (value instanceof Display) {
			...
			axisRangeElement.setAttribute(XML_ATTRIBUTE_MINFIXED, String.valueOf(abs.getFixedRange().getMinimum()));
			axisRangeElement.setAttribute(XML_ATTRIBUTE_MAXFIXED, String.valueOf(abs.getFixedRange().getMaximum()));
		}
