package org.csstudio.swt.xygraph.pvmanager;
...
public class SelectionValueExporter extends MouseMotionListener.Stub {
	...
	/**
	 * Constructs a new SelectionValueExporter, which is not attached to anything.
	 * Use {@link #setPlot(PlotArea)} to attach the exporter to a source.
	 */
	public SelectionValueExporter() {
	 ...
	 */
	public void setPlot(PlotArea plot) {
		if (this.plot != null) {
