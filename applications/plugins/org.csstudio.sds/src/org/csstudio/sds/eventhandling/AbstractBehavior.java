...
public abstract class AbstractBehavior<W extends AbstractWidgetModel> {
	...
	public final void setInitializationData(final IConfigurationElement config, final String propertyName, final Object data) throws CoreException {
	 ...
	 */
	public void processChannelDataUpdate(final W model, final AnyDataChannel channel) {
		AnyData data = channel.getData();

		// .. handle meta data
		if (latestMetaData != data.getMetaData()) {
			latestMetaData = data.getMetaData();
			doProcessMetaDataChange(model, latestMetaData);
		}
...
//		}
	 ...
	 */
	public final Object convertOutgoingValue(final W widgetModel, final String propertyId, final Object value) {
