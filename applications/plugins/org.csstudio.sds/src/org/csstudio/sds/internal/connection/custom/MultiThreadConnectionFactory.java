...
/**
 * Connection factory implementation for multi threaded test connections.
 * 
 * @author Sven Wende
 * 
 */
public final class MultiThreadConnectionFactory implements IConnectorFactory {

	/**
	 * {@inheritDoc}
	 */
	public Connector createConnector(final IProcessVariableAddress processVariable) {
		return new CustomChannelReadConnector(processVariable);
	}
