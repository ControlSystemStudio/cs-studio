...
public class BOYPVFactory{	
	 ...
	 * rate is determined by GUI Refresh cycle.
	 * @param name name of the PV.
	 * @return the PV
	 * @throws Exception
	 * @see {@link #createPV(String, boolean, int)}
	 */
	public static PV createPV(String name) throws Exception {
	 ...
	 * @see {@link #createPV(String, boolean, int)}
	 */
	public static PV createPV(String name, boolean bufferAllValues) throws Exception{
	 ...
	 * @throws Exception
	 */
	public static PV createPV(String name, 
			boolean bufferAllValues, int updateDuration) throws Exception{
