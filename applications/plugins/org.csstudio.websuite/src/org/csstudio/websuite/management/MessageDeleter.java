...
import org.csstudio.websuite.RemotlyAccessible;
 ...
 * @since 19.04.2010
 */
public class MessageDeleter implements IManagementCommand {
    ...
    public CommandResult execute(CommandParameters parameters) {
        objectToBeManaged.deleteAllMessages();
        return CommandResult.createMessageResult("All messages deleted.");
    }
