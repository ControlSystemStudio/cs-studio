...
/**
 * Command handler for opening the alarm tree
 *
 * @author carcassi, Kay Kasemir, Kunal Shroff
 */
public class OpenPhoebusAlarmTree extends AbstractHandler implements IHandler {
    ...
    public Object execute(final ExecutionEvent event) throws ExecutionException {
        ...
        if(topics != null && topics.isEmpty()) {
            PhoebusLauncherService.launchApplication(Messages.AlarmTree);
        }
        ...
        topics.forEach(topic -> {
            ...
            try {
                ...
                log.log(Level.WARNING, "Failed to launch the alarm tree", e);
            }
        });
        return null;
    }
