...
public class OpenPhoebusProbe extends AbstractHandler implements IHandler {
    /** {@inheritDoc} */
    @Override
    public Object execute(final ExecutionEvent event) throws ExecutionException {
        ...
        try {
            ...
            if (pvs == null || pvs.length <= 0) {
                PhoebusLauncherService.launchApplication(Messages.Probe);
            } else {
                ...
                query = query + "&" + "app="+Messages.Probe;
