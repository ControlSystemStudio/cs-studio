...
import org.csstudio.saverestore.git.GitResourceManager.ChangeType;
import org.csstudio.saverestore.git.GitResourceManager.Result;
...
public class GitDataProvider implements DataProvider {
    ...
    public GitDataProvider() {
        ...
        grm = new GitResourceManager();
        Engine.getInstance().execute("Git Initialise", () -> {
            try {
     ...
     */
    @Override
    public String createNewBranch(String originalBranch, String newBranchName) throws DataProviderException {
